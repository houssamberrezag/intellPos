...
export class DamageComponent implements OnInit {
  ...
  trackId(index: number, item: IDamage): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IDamage[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
