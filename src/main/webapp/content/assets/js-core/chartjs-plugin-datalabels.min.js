...
!(function (t, e) {
  ...
  var s = {
      ...
      rect: function (t, e, n, a) {
        var r = t.horizontal,
          ...
          s = u(t, a);
        return (
          'center' === e ? (r ? (o += i / 2) : (l += i / 2)) : 'start' !== e || r ? 'end' === e && r && (o += i) : (l += i),
          d(o, l, s.x, s.y, n)
        );
      },
  ...
  v.extend(b.prototype, {
    ...
    update: function (t) {
      var e,
        ...
        i = this._index,
        o = this._config;
      v.options.resolve([o.display, !0], t, i) &&
        ((e = t.dataset.data[i]),
        (n = v.valueOrDefault(v.callback(o.formatter, [e, t]), e)),
        (r = (a = v.isNullOrUndef(n) ? [] : g.toTextLines(n)).length ? this._modelize(a, o, t) : null)),
        (this._model = r);
    },
    draw: function (t) {
      var e,
      ...
      x &&
        ...
        (o = a.width),
        (s = -i / 2),
        (e = { frame: { x: (l = -o / 2) - r.left, y: s - r.top, w: o + r.width, h: i + r.height }, text: { x: l, y: s, w: o, h: i } }),
        (n = (function (t, e, n) {
        ...
        this._hitbox.update(n, e.frame, x.rotation),
        t.save(),
        (t.globalAlpha = g.bound(0, x.opacity, 1)),
        t.translate(Math.round(n.x), Math.round(n.y)),
        t.rotate(x.rotation),
        (u = t),
        (d = e.frame),
        (c = (f = x).backgroundColor),
        (h = f.borderColor),
        (y = f.borderWidth),
        (c || (h && y)) &&
          (u.beginPath(),
          ...
          u.closePath(),
          c && ((u.fillStyle = c), u.fill()),
          h && y && ((u.strokeStyle = h), (u.lineWidth = y), (u.lineJoin = 'miter'), u.stroke())),
        (function (t, e, n, a) {
          var r,
            i,
            o,
  ...
  function c(t, e, n) {
    ...
    for (a = l.length - 1; 0 <= a; --a)
      for (r = (i = l[a] || []).length - 1; 0 <= r; --r) if ((o = i[r]).contains(e, n)) return { dataset: a, label: o };
    return null;
  }
  function h(t, e, n) {
    var a = e && e[n.dataset];
  ...
  function f(t, e) {
    ...
    if (i.enter || i.leave) {
      ...
      (n = r.hovered),
        ...
        (u = a),
        ((s = n) || u) &&
          (s ? (u ? s.label !== u.label && (f = d = !0) : (f = !0)) : (d = !0), f && h(o, l.leave, s), d && h(o, l.enter, u));
    }
  }
  (l.defaults.global.plugins.datalabels = e),
    (l.defaults.global.plugins.datalabels = e),
    l.plugins.register({
      id: 'datalabels',
      ...
      afterDatasetUpdate: function (t, a, e) {
        var n,
          ...
          y = h.length,
          x = t.ctx;
        for (x.save(), i = 0; i < y; ++i)
          !(o = h[i]) || o.hidden || o._model.skip
            ? (l = null)
            : (d.push((l = new b(c, x, o, i))),
              l.update((l.$context = { active: !1, chart: t, dataIndex: i, dataset: f, datasetIndex: s }))),
            (o[m] = l);
        x.restore(),
          p.merge(u.listeners, c.listeners || {}, {
