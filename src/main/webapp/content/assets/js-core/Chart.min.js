        ...
        (n.prototype = {
          ...
          luminosity: function () {
            for (var t = this.values.rgb, e = [], i = 0; i < t.length; i++) {
              var a = t[i] / 255;
              e[i] = 0.03928 >= a ? a / 12.92 : Math.pow((a + 0.055) / 1.055, 2.4);
            }
          ...
          mix: function (t, e) {
            var i = this,
              ...
              l = 1 - s;
            return this.rgb(s * i.red() + l * a.red(), s * i.green() + l * a.green(), s * i.blue() + l * a.blue()).alpha(
              i.alpha() * o + a.alpha() * (1 - o)
            );
          },
          toJSON: function () {
            return this.rgb();
      ...
      function (t, e, i) {
        function a(t) {
          var e,
            ...
            h = l - s;
          return (
            l == s ? (e = 0) : o == l ? (e = (n - r) / h) : n == l ? (e = 2 + (r - o) / h) : r == l && (e = 4 + (o - n) / h),
            (e = Math.min(60 * e, 360)),
            0 > e && (e += 360),
            (a = (s + l) / 2),
            (i = l == s ? 0 : 0.5 >= a ? h / (l + s) : h / (2 - l - s)),
            [e, 100 * i, 100 * a]
          );
        }
        function o(t) {
        ...
        function u(t) {
          ...
          (i = 0.5 > l ? l * (1 + s) : l + s - l * s), (e = 2 * l - i), (o = [0, 0, 0]);
          for (var h = 0; 3 > h; h++)
            (a = r + (1 / 3) * -(h - 1)),
              0 > a && a++,
              a > 1 && a--,
              (n = 1 > 6 * a ? e + 6 * (i - e) * a : 1 > 2 * a ? i : 2 > 3 * a ? e + (i - e) * (2 / 3 - a) * 6 : e),
              (o[h] = 255 * n);
          return o;
        }
        function f(t) {
          ...
          return 0 === n
            ? [0, 0, 0]
            : ((n *= 2), (o *= 1 >= n ? n : 2 - n), (i = (n + o) / 2), (e = (2 * o) / (n + o)), [a, 100 * e, 100 * i]);
        }
        function p(t) {
          return n(u(t));
        }
        ...
        function L(t) {
          ...
          return (
            8 >= n
              ? ((i = (100 * n) / 903.3), (o = 7.787 * (i / 100) + 16 / 116))
              : ((i = 100 * Math.pow((n + 16) / 116, 3)), (o = Math.pow(i / 100, 1 / 3))),
            (e = 0.008856 >= e / 95.047 ? (e = (95.047 * (r / 500 + o - 16 / 116)) / 7.787) : 95.047 * Math.pow(r / 500 + o, 3)),
            (a = 0.008859 >= a / 108.883 ? (a = (108.883 * (o - s / 200 - 16 / 116)) / 7.787) : 108.883 * Math.pow(o - s / 200, 3)),
            [e, i, a]
          );
        }
        function B(t) {
          ...
          (t.defaults.bar = {
            ...
            (t.controllers.bar = t.DatasetController.extend({
                ...
                e.extend(t, {
                  ...
                  _model: {
                    ...
                    backgroundColor: h.backgroundColor
                      ? h.backgroundColor
                      : e.getValueAtIndexOrDefault(d.backgroundColor, i, l.backgroundColor),
              ...
              getRuler: function (t) {
                ...
                return { datasetCount: o, tickWidth: e, categoryWidth: n, categorySpacing: r, fullBarWidth: s, barWidth: h, barSpacing: d };
              },
              ...
              calculateBarX: function (t, e) {
                ...
                return (
                  (r -= this.chart.isCombo ? n.tickWidth / 2 : 0),
                  a.options.stacked
                    ? r + n.categoryWidth / 2 + n.categorySpacing
                    : r + n.barWidth / 2 + n.categorySpacing + n.barWidth * o + n.barSpacing / 2 + n.barSpacing * o
                );
              },
                ...
                if (a.options.stacked) {
                  for (var n = 0, r = 0, s = 0; e > s; s++) {
                    ...
                    h.bar &&
                      ...
                      (l.data[t] < 0 ? (r += l.data[t] || 0) : (n += l.data[t] || 0));
                  }
              ...
              setHoverStyle: function (t) {
                ...
                (n.backgroundColor = o.hoverBackgroundColor
                  ...
                  : e.getValueAtIndexOrDefault(i.hoverBackgroundColor, a, e.getHoverColor(n.backgroundColor))),
                  (n.borderColor = o.hoverBorderColor
                    ? o.hoverBorderColor
                    : e.getValueAtIndexOrDefault(i.hoverBorderColor, a, e.getHoverColor(n.borderColor))),
                  (n.borderWidth = o.hoverBorderWidth
                    ? o.hoverBorderWidth
                    : e.getValueAtIndexOrDefault(i.hoverBorderWidth, a, n.borderWidth));
              },
              removeHoverStyle: function (t) {
                ...
                (n.backgroundColor = o.backgroundColor
                  ? o.backgroundColor
                  : e.getValueAtIndexOrDefault(i.backgroundColor, a, r.backgroundColor)),
                  (n.borderColor = o.borderColor ? o.borderColor : e.getValueAtIndexOrDefault(i.borderColor, a, r.borderColor)),
                  (n.borderWidth = o.borderWidth ? o.borderWidth : e.getValueAtIndexOrDefault(i.borderWidth, a, r.borderWidth));
              },
            })),
            ...
            (t.controllers.horizontalBar = t.controllers.bar.extend({
              updateElement: function (t, i, a, o) {
                ...
                e.extend(t, {
                  ...
                  _model: {
                    ...
                    backgroundColor: h.backgroundColor
                      ? h.backgroundColor
                      : e.getValueAtIndexOrDefault(d.backgroundColor, i, c.backgroundColor),
                  ...
                  inRange: function (t, e) {
                    ...
                    return (
                      i &&
                        (a =
                          i.x < i.base
                            ? e >= i.y - i.height / 2 && e <= i.y + i.height / 2 && t >= i.x && t <= i.base
                            : e >= i.y - i.height / 2 && e <= i.y + i.height / 2 && t >= i.base && t <= i.x),
                      a
                    );
                  },
                }),
              ...
              calculateBarY: function (t, e) {
                var i = this.getMeta(),
                  ...
                  r = a.getPixelForValue(null, t, e, this.chart.isCombo);
                return (
                  (r -= this.chart.isCombo ? n.tickHeight / 2 : 0),
                  a.options.stacked
                    ? r + n.categoryHeight / 2 + n.categorySpacing
                    : r + n.barHeight / 2 + n.categorySpacing + n.barHeight * o + n.barSpacing / 2 + n.barSpacing * o
                );
              },
            }));
        };
            ...
            (t.controllers.bubble = t.DatasetController.extend({
              ...
              updateElement: function (t, i, a) {
                ...
                e.extend(t, {
                  ...
                  _index: i,
                  _model: {
                    x: a ? n.getPixelForDecimal(0.5) : n.getPixelForValue(h, i, this.index, this.chart.isCombo),
                    y: a ? r.getBasePixel() : r.getPixelForValue(h, i, this.index),
                    radius: a ? 0 : s.radius ? s.radius : this.getRadius(h),
                    backgroundColor: s.backgroundColor
                      ? s.backgroundColor
                      : e.getValueAtIndexOrDefault(l.backgroundColor, i, d.backgroundColor),
              ...
              setHoverStyle: function (t) {
                ...
                (n.radius = o.hoverRadius
                  ? o.hoverRadius
                  : e.getValueAtIndexOrDefault(i.hoverRadius, a, this.chart.options.elements.point.hoverRadius) +
              ...
              removeHoverStyle: function (t) {
                ...
                (n.radius = o.radius ? o.radius : this.getRadius(i.data[t._index])),
                  (n.backgroundColor = o.backgroundColor
                    ? o.backgroundColor
                    : e.getValueAtIndexOrDefault(i.backgroundColor, a, r.backgroundColor)),
                  (n.borderColor = o.borderColor ? o.borderColor : e.getValueAtIndexOrDefault(i.borderColor, a, r.borderColor)),
            ...
            legendCallback: function (t) {
              ...
              if (a.length)
                for (var n = 0; n < a[0].data.length; ++n)
                  e.push('<li><span style="background-color:' + a[0].backgroundColor[n] + '"></span>'),
                    o[n] && e.push(o[n]),
                    e.push('</li>');
            ...
            (t.controllers.doughnut = t.controllers.pie =
              t.DatasetController.extend({
                ...
                update: function (t) {
                  ...
                  if (f < 2 * Math.PI) {
                    ...
                    var p = g + f,
                      ...
                      M = { width: 0.5 * (w.x - C.x), height: 0.5 * (w.y - C.y) };
                    (h = Math.min(s / M.width, l / M.height)), (d = { x: (w.x + C.x) * -0.5, y: (w.y + C.y) * -0.5 });
                  }
                  (a.outerRadius = Math.max(h / 2, 0)),
                    (a.innerRadius = Math.max(u ? (a.outerRadius / 100) * u : 1, 0)),
                    ...
                    (i.outerRadius = a.outerRadius - a.radiusLength * i.getRingIndex(i.index)),
                    (i.innerRadius = i.outerRadius - a.radiusLength),
                ...
                updateElement: function (t, i, a) {
                  ...
                  var y = t._model;
                  (y.backgroundColor = v.backgroundColor ? v.backgroundColor : x(g.backgroundColor, i, h.backgroundColor)),
                    (y.hoverBackgroundColor = v.hoverBackgroundColor
                      ? v.hoverBackgroundColor
                      : x(g.hoverBackgroundColor, i, h.hoverBackgroundColor)),
                    (y.borderWidth = v.borderWidth ? v.borderWidth : x(g.borderWidth, i, h.borderWidth)),
                    (y.borderColor = v.borderColor ? v.borderColor : x(g.borderColor, i, h.borderColor)),
                    (a && l.animateRotate) ||
                      (0 === i ? (y.startAngle = s.rotation) : (y.startAngle = o.getMeta().data[i - 1]._model.endAngle),
          ...
          (t.defaults.line = {
            ...
            (t.controllers.line = t.DatasetController.extend({
              ...
              addElementAndReset: function (e) {
                var i = this,
                  a = i.chart.options;
                t.DatasetController.prototype.addElementAndReset.call(i, e),
                  a.showLines && 0 !== a.elements.line.tension && i.updateBezierControlPoints();
              },
              update: function (t) {
                var i,
                  a,
              ...
              getPointBackgroundColor: function (t, i) {
                ...
                return (
                  n.backgroundColor
                    ...
                    ? (a = e.getValueAtIndexOrDefault(o.pointBackgroundColor, i, a))
              ...
              getPointBorderColor: function (t, i) {
                ...
                return (
                  n.borderColor
                    ? (a = n.borderColor)
                    : o.pointBorderColor
                    ? (a = e.getValueAtIndexOrDefault(o.pointBorderColor, i, a))
              ...
              updateElement: function (t, i, a) {
                ...
                void 0 !== h.radius && void 0 === h.pointRadius && (h.pointRadius = h.radius),
                  void 0 !== h.hitRadius && void 0 === h.pointHitRadius && (h.pointHitRadius = h.hitRadius),
                  (o = f.getPixelForValue(c, i, d, r.chart.isCombo)),
                  (n = a ? u.getBasePixel() : r.calculatePointY(c, i, d, r.chart.isCombo)),
                  (t._xScale = f),
                  (t._yScale = u),
                  (t._datasetIndex = d),
                  (t._index = i),
                ...
                if (d.options.stacked) {
                  for (o = 0; i > o; o++)
                    (n = l.data.datasets[o]),
                      ...
                      'line' === r.type && l.isDatasetVisible(o) && (n.data[e] < 0 ? (u += n.data[e] || 0) : (c += n.data[e] || 0));
              ...
              updateBezierControlPoints: function () {
                ...
                for (t = 0, i = l.length; i > t; ++t)
                  (a = l[t]),
                    (o = a._model),
                    (n = e.splineCurve(e.previousItem(l, t)._model, o, e.nextItem(l, t)._model, r.dataset._model.tension)),
                    (o.controlPointPreviousX = Math.max(Math.min(n.previous.x, s.right), s.left)),
                    (o.controlPointPreviousY = Math.max(Math.min(n.previous.y, s.bottom), s.top)),
                    (o.controlPointNextX = Math.max(Math.min(n.next.x, s.right), s.left)),
                    (o.controlPointNextY = Math.max(Math.min(n.next.y, s.bottom), s.top)),
                    a.pivot();
              },
              draw: function (t) {
                var e,
              ...
              setHoverStyle: function (t) {
                var i = this.chart.data.datasets[t._datasetIndex],
                  ...
                  n = t._model;
                (n.radius =
                  o.hoverRadius || e.getValueAtIndexOrDefault(i.pointHoverRadius, a, this.chart.options.elements.point.hoverRadius)),
                  (n.backgroundColor =
                    o.hoverBackgroundColor ||
                    e.getValueAtIndexOrDefault(i.pointHoverBackgroundColor, a, e.getHoverColor(n.backgroundColor))),
                  (n.borderColor =
                    o.hoverBorderColor || e.getValueAtIndexOrDefault(i.pointHoverBorderColor, a, e.getHoverColor(n.borderColor))),
                  (n.borderWidth = o.hoverBorderWidth || e.getValueAtIndexOrDefault(i.pointHoverBorderWidth, a, n.borderWidth));
              },
              removeHoverStyle: function (t) {
                var i = this,
                ...
                void 0 !== a.radius && void 0 === a.pointRadius && (a.pointRadius = a.radius),
                  (r.radius = n.radius || e.getValueAtIndexOrDefault(a.pointRadius, o, i.chart.options.elements.point.radius)),
                  (r.backgroundColor = i.getPointBackgroundColor(t, o)),
                  (r.borderColor = i.getPointBorderColor(t, o)),
                  (r.borderWidth = i.getPointBorderWidth(t, o));
              },
            }));
        };
      },
        ...
        e.exports = function (t) {
          ...
          (t.defaults.polarArea = {
            ...
            legendCallback: function (t) {
              ...
              if (a.length)
                for (var n = 0; n < a[0].data.length; ++n)
                  e.push('<li><span style="background-color:' + a[0].backgroundColor[n] + '">'),
                    o[n] && e.push(o[n]),
                    e.push('</span></li>');
              return e.push('</ul>'), e.join('');
            },
            ...
            (t.controllers.polarArea = t.DatasetController.extend({
              ...
              update: function (t) {
                ...
                (a.outerRadius = Math.max((l - s.borderWidth / 2) / 2, 0)),
                  (a.innerRadius = Math.max(r.cutoutPercentage ? (a.outerRadius / 100) * r.cutoutPercentage : 1, 0)),
                  (a.radiusLength = (a.outerRadius - a.innerRadius) / a.getVisibleDatasetCount()),
                  (i.outerRadius = a.outerRadius - a.radiusLength * i.index),
                  (i.innerRadius = i.outerRadius - a.radiusLength),
              ...
              updateElement: function (t, i, a) {
                ...
                var k = t.hidden ? 0 : u.getDistanceFromCenterForValue(s.data[i]),
                  ...
                  w = {
                    ...
                    startAngle: h.animateRotate ? Math.PI * -0.5 : S,
                    endAngle: h.animateRotate ? Math.PI * -0.5 : C,
            ...
            (t.controllers.radar = t.DatasetController.extend({
                ...
                e.extend(t, {
                  ...
                  _model: {
                    ...
                    backgroundColor: o.backgroundColor
                      ? o.backgroundColor
                      : e.getValueAtIndexOrDefault(n.pointBackgroundColor, i, s.backgroundColor),
              ...
              updateBezierControlPoints: function () {
                ...
                e.each(
                  ...
                  function (a, o) {
                    ...
                    (n.controlPointPreviousX = Math.max(Math.min(r.previous.x, t.right), t.left)),
                      (n.controlPointPreviousY = Math.max(Math.min(r.previous.y, t.bottom), t.top)),
                      (n.controlPointNextX = Math.max(Math.min(r.next.x, t.right), t.left)),
                      (n.controlPointNextY = Math.max(Math.min(r.next.y, t.bottom), t.top)),
                      a.pivot();
                  },
                  this
                );
              ...
              setHoverStyle: function (t) {
                ...
                (n.radius = a.hoverRadius
                  ? a.hoverRadius
                  : e.getValueAtIndexOrDefault(i.pointHoverRadius, o, this.chart.options.elements.point.hoverRadius)),
                  (n.backgroundColor = a.hoverBackgroundColor
                    ? a.hoverBackgroundColor
                    : e.getValueAtIndexOrDefault(i.pointHoverBackgroundColor, o, e.getHoverColor(n.backgroundColor))),
                  (n.borderColor = a.hoverBorderColor
                    ? a.hoverBorderColor
                    : e.getValueAtIndexOrDefault(i.pointHoverBorderColor, o, e.getHoverColor(n.borderColor))),
                  (n.borderWidth = a.hoverBorderWidth
                    ? a.hoverBorderWidth
                    : e.getValueAtIndexOrDefault(i.pointHoverBorderWidth, o, n.borderWidth));
              },
              removeHoverStyle: function (t) {
                var i = this.chart.data.datasets[t._datasetIndex],
                  a = t.custom || {},
                  ...
                  n = t._model,
                  r = this.chart.options.elements.point;
                (n.radius = a.radius ? a.radius : e.getValueAtIndexOrDefault(i.radius, o, r.radius)),
                  (n.backgroundColor = a.backgroundColor
                    ? a.backgroundColor
                    : e.getValueAtIndexOrDefault(i.pointBackgroundColor, o, r.backgroundColor)),
                  (n.borderColor = a.borderColor ? a.borderColor : e.getValueAtIndexOrDefault(i.pointBorderColor, o, r.borderColor)),
                  (n.borderWidth = a.borderWidth ? a.borderWidth : e.getValueAtIndexOrDefault(i.pointBorderWidth, o, r.borderWidth));
              },
            }));
        };
      },
            ...
            (t.Controller = function (i) {
              return (
                ...
                (this.options = this.config.options =
                  e.configMerge(t.defaults.global, t.defaults[this.config.type], this.config.options || {})),
                (this.id = e.uid()),
            ...
            e.extend(t.Controller.prototype, {
              ...
              resize: function (t) {
                ...
                return n
                  ? ((i.width = this.chart.width = a),
                    ...
                    t || (this.stop(), this.update(this.options.responsiveAnimationDuration)),
                    this)
                  : this;
              },
              ...
              buildScales: function () {
                ...
                a.scales &&
                  ...
                  a.scale && n.push({ options: a.scale, dtype: 'radialLinear', isDefault: !0 }),
              ...
              buildSurroundingItems: function () {
                this.options.title &&
                  ((this.titleBlock = new t.Title({ ctx: this.chart.ctx, options: this.options.title, chart: this })),
                  t.layoutService.addBox(this, this.titleBlock)),
                  this.options.legend &&
                    ((this.legend = new t.Legend({ ctx: this.chart.ctx, options: this.options.legend, chart: this })),
                ...
                if (
                  (e.each(
                    ...
                    function (e, o) {
                      ...
                      n.type || (n.type = e.type || this.config.type),
                        i.push(n.type),
                        n.controller
                          ? n.controller.updateIndex(o)
                          : ((n.controller = new t.controllers[n.type](this, o)), a.push(n.controller));
                    },
                    this
                  ),
                  i.length > 1)
              ...
              update: function (i, a) {
                ...
                e.each(
                  ...
                  t.layoutService.update(this, this.chart.width, this.chart.height),
                  t.pluginService.notifyPlugins('afterScaleUpdate', [this]),
                  e.each(o, function (t) {
                    t.reset();
                  }),
                  e.each(
              ...
              render: function (i, a) {
                ...
                if (o && (('undefined' != typeof i && 0 !== i) || ('undefined' == typeof i && 0 !== o.duration))) {
                  ...
                  (n.numSteps = (i || o.duration) / 16.66),
                    ...
                    t.animationService.addAnimation(this, n, i, a);
                    ...
                    if (this.data.datasets)
                      for (var t = 0; t < this.data.datasets.length; t++) {
                        ...
                        if (this.isDatasetVisible(t))
                          for (var a = 0; a < e.data.length; a++) if (e.data[a].inRange(i.x, i.y)) return e.data[a];
                      }
                  }.call(this);
                return o
                  ? (e.each(
              ...
              eventHandler: function (t) {
                ...
                return (
                  ...
                  (i.lastTooltipActive = i.lastTooltipActive || []),
                  'mouseout' === t.type
                    ? ((i.active = []), (i.tooltipActive = []))
                    : ((i.active = i.getElementsAtEventForMode(t, n.mode)), (i.tooltipActive = i.getElementsAtEventForMode(t, r.mode))),
                  n.onHover && n.onHover.call(i, i.active),
                  ('mouseup' === t.type || 'click' === t.type) &&
                    (o.onClick && o.onClick.call(i, t, i.active), i.legend && i.legend.handleEvent && i.legend.handleEvent(t)),
                  i.lastActive.length && i.updateHoverStyle(i.lastActive, n.mode, !1),
                  i.active.length && n.mode && i.updateHoverStyle(i.active, n.mode, !0),
                  (r.enabled || r.custom) && (a.initialize(), (a._active = i.tooltipActive), a.update(!0)),
                  a.pivot(),
                  i.animating ||
                    (e.arrayEquals(i.active, i.lastActive) && e.arrayEquals(i.tooltipActive, i.lastTooltipActive)) ||
                    (i.stop(), (r.enabled || r.custom) && a.update(!0), i.render(n.animationDuration, !0)),
          ...
          (t.DatasetController = function (t, e) {
            ...
            e.extend(t.DatasetController.prototype, {
              ...
              buildOrUpdateElements: function () {
                ...
                else if (i > a) for (var o = a; i > o; ++o) this.addElementAndReset(o);
              },
              update: i,
              draw: function (t) {
                var i = t || 1;
              ...
              removeHoverStyle: function (t, i) {
                var a = this.chart.data.datasets[t._datasetIndex],
                  ...
                  s = (e.color, t._model);
                (s.backgroundColor = n.backgroundColor ? n.backgroundColor : r(a.backgroundColor, o, i.backgroundColor)),
                  (s.borderColor = n.borderColor ? n.borderColor : r(a.borderColor, o, i.borderColor)),
                  (s.borderWidth = n.borderWidth ? n.borderWidth : r(a.borderWidth, o, i.borderWidth));
              },
              setHoverStyle: function (t) {
                var i = this.chart.data.datasets[t._datasetIndex],
                  a = t._index,
                  ...
                  s = t._model;
                (s.backgroundColor = o.hoverBackgroundColor ? o.hoverBackgroundColor : n(i.hoverBackgroundColor, a, r(s.backgroundColor))),
                  (s.borderColor = o.hoverBorderColor ? o.hoverBorderColor : n(i.hoverBorderColor, a, r(s.borderColor))),
                  (s.borderWidth = o.hoverBorderWidth ? o.hoverBorderWidth : n(i.hoverBorderWidth, a, s.borderWidth));
              },
            }),
      ...
      function (t, e, i) {
        ...
        e.exports = function (t) {
          ...
          (n.each = function (t, e, i, a) {
            var o, r;
            if (n.isArray(t))
              if (((r = t.length), a)) for (o = r - 1; o >= 0; o--) e.call(i, t[o], o);
            ...
            (n.configMerge = function (e) {
              var i = n.clone(e);
              return (
                n.each(Array.prototype.slice.call(arguments, 1), function (e) {
                  n.each(e, function (e, a) {
                    if ('scales' === a) i[a] = n.scaleMerge(i.hasOwnProperty(a) ? i[a] : {}, e);
                    else if ('scale' === a)
                      i[a] = n.configMerge(i.hasOwnProperty(a) ? i[a] : {}, t.scaleService.getScaleDefaults(e.type), e);
                    else if (i.hasOwnProperty(a) && n.isArray(i[a]) && n.isArray(e)) {
                      var o = i[a];
                      n.each(e, function (t, e) {
                        e < o.length
                          ? 'object' == typeof o[e] && null !== o[e] && 'object' == typeof t && null !== t
                            ? (o[e] = n.configMerge(o[e], t))
                            : (o[e] = t)
                          : o.push(t);
                      });
                    } else
                      i.hasOwnProperty(a) && 'object' == typeof i[a] && null !== i[a] && 'object' == typeof e
                        ? (i[a] = n.configMerge(i[a], e))
                        : (i[a] = e);
                  });
                }),
                i
                  ...
                  'xAxes' === i || 'yAxes' === i
                    ? a.hasOwnProperty(i)
                      ? n.each(e, function (e, o) {
                          ...
                          o >= a[i].length || !a[i][o].type
                            ? a[i].push(n.configMerge(s, e))
                            : e.type && e.type !== a[i][o].type
                            ? (a[i][o] = n.configMerge(a[i][o], s, e))
                            : (a[i][o] = n.configMerge(a[i][o], e));
                        })
                      : ((a[i] = []),
                        n.each(e, function (e) {
            ...
            (n.getAngleFromPoint = function (t, e) {
              var i = e.x - t.x,
                ...
                o = Math.sqrt(i * i + a * a),
                n = Math.atan2(a, i);
              return n < -0.5 * Math.PI && (n += 2 * Math.PI), { angle: n, distance: o };
            }),
          ...
          var r = (n.easingEffects = {
            ...
            easeInElastic: function (t) {
              ...
              return 0 === t
                ...
                ? 1
                : (i || (i = 0.3),
                  a < Math.abs(1) ? ((a = 1), (e = i / 4)) : (e = (i / (2 * Math.PI)) * Math.asin(1 / a)),
                  -(a * Math.pow(2, 10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / i)));
            },
            easeOutElastic: function (t) {
              ...
              return 0 === t
                ...
                : (i || (i = 0.3),
                  a < Math.abs(1) ? ((a = 1), (e = i / 4)) : (e = (i / (2 * Math.PI)) * Math.asin(1 / a)),
                  a * Math.pow(2, -10 * t) * Math.sin(((1 * t - e) * (2 * Math.PI)) / i) + 1);
            },
            easeInOutElastic: function (t) {
              ...
              return 0 === t
                ...
                : (i || (i = 1 * (0.3 * 1.5)),
                  a < Math.abs(1) ? ((a = 1), (e = i / 4)) : (e = (i / (2 * Math.PI)) * Math.asin(1 / a)),
                  1 > t
                    ? -0.5 * (a * Math.pow(2, 10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / i))
                    : a * Math.pow(2, -10 * (t -= 1)) * Math.sin(((1 * t - e) * (2 * Math.PI)) / i) * 0.5 + 1);
            },
          ...
          (n.requestAnimFrame = (function () {
            ...
            (n.getRelativePosition = function (t, e) {
              ...
              return (
                (i = Math.round((((i - s.left - h) / f) * r.width) / e.currentDevicePixelRatio)),
                (a = Math.round((((a - s.top - d) / g) * r.height) / e.currentDevicePixelRatio)),
                { x: i, y: a }
              );
            }),
            ...
            (n.retinaScale = function (t) {
              ...
              1 !== n &&
                ((i.height = o * n), (i.width = a * n), e.scale(n, n), (t.originalDevicePixelRatio = t.originalDevicePixelRatio || n)),
                (i.style.width = a + 'px'),
                (i.style.height = o + 'px');
            }),
            (n.clear = function (t) {
            ...
            (n.drawRoundedRectangle = function (t, e, i, a, o, n) {
              t.beginPath(),
                ...
                t.lineTo(e + a, i + o - n),
                t.quadraticCurveTo(e + a, i + o, e + a - n, i + o),
                t.lineTo(e + n, i + o),
            ...
            (n.getHoverColor = function (t) {
              return t instanceof CanvasPattern ? t : n.color(t).saturate(0.5).darken(0.1).rgbString();
            });
        };
      },
      { 'chartjs-color': 3 },
        ...
        e.exports = function () {
          var t = function (e, i) {
            (this.config = i),
              ...
              (this.width = e.canvas.width || parseInt(t.helpers.getStyle(e.canvas, 'width')) || t.helpers.getMaximumWidth(e.canvas)),
              (this.height = e.canvas.height || parseInt(t.helpers.getStyle(e.canvas, 'height')) || t.helpers.getMaximumHeight(e.canvas)),
              (this.aspectRatio = this.width / this.height),
              (isNaN(this.aspectRatio) || isFinite(this.aspectRatio) === !1) &&
                (this.aspectRatio = void 0 !== i.aspectRatio ? i.aspectRatio : 2),
          ...
          t.layoutService = {
            ...
            update: function (t, i, a) {
              function o(t) {
                var e,
                  i = t.isHorizontal();
                i ? ((e = t.update(t.options.fullWidth ? p : k, y)), (S -= e.height)) : ((e = t.update(x, v)), (k -= e.width)),
              ...
              function s(t) {
                t.isHorizontal()
                  ? ((t.left = t.options.fullWidth ? l : w),
                    (t.right = t.options.fullWidth ? i - l : w + k),
                    (t.top = P),
                    (t.bottom = P + t.height),
                    (P = t.bottom))
                  : ((t.left = _), (t.right = _ + t.width), (t.top = D), (t.bottom = D + S), (_ = t.right));
              }
              if (t) {
                var l = 0,
                  h = 0,
                ...
                e.each(d.concat(u), s),
                  ...
                  e.each(c, s),
                  e.each(f, s),
                  (t.chartArea = { left: w, top: D, right: w + k, bottom: D + S }),
                  e.each(g, function (e) {
            ...
            (t.Legend = t.Element.extend({
              ...
              fit: function () {
                var i = this.options,
                  ...
                  g = this.isHorizontal();
                if (
                  (g ? ((f.width = this.maxWidth), (f.height = o ? 10 : 0)) : ((f.width = o ? 10 : 0), (f.height = this.maxHeight)), o && g)
                ) {
                  ...
                  (n.textAlign = 'left'),
                    ...
                    e.each(
                      ...
                      function (t, e) {
                        ...
                        p[p.length - 1] + i + a.padding >= this.width && ((m += l + a.padding), (p[p.length] = this.left)),
                          (u[e] = { left: 0, top: 0, width: i, height: l }),
                    ...
                    e.each(
                      ...
                      function (t, e) {
                        var i = l.measureText(t.text).width,
                          ...
                          f = h.x,
                          g = h.y;
                        f + c >= r && ((g = h.y += u + a.padding), h.line++, (f = h.x = this.left + (r - s[h.line]) / 2)),
                          l.save(),
                          (l.fillStyle = d(t.fillStyle, o.defaultColor)),
                          (l.lineCap = d(t.lineCap, n.borderCapStyle)),
                          (l.lineDashOffset = d(t.lineDashOffset, n.borderDashOffset)),
                          (l.lineJoin = d(t.lineJoin, n.borderJoinStyle)),
                          (l.lineWidth = d(t.lineWidth, n.borderWidth)),
                          (l.strokeStyle = d(t.strokeStyle, o.defaultColor)),
                          l.setLineDash && l.setLineDash(d(t.lineDash, n.borderDash)),
                          l.strokeRect(f, g, m, u),
                          l.fillRect(f, g, m, u),
                          l.restore(),
                          (b[e].left = f),
                          (b[e].top = g),
                          l.fillText(t.text, m + u / 2 + f, g),
                          t.hidden &&
                            (l.beginPath(),
                            (l.lineWidth = 2),
                            l.moveTo(m + u / 2 + f, g + u / 2),
                            l.lineTo(m + u / 2 + f + i, g + u / 2),
                            l.stroke()),
                          (h.x += c + a.padding);
                      },
                      this
            ...
            (t.Scale = t.Element.extend({
              ...
              update: function (t, i, a) {
                return (
                  ...
                  (this.maxWidth = t),
                  (this.maxHeight = i),
                  (this.margins = e.extend({ left: 0, right: 0, top: 0, bottom: 0 }, a)),
                  this.beforeSetDimensions(),
                  this.setDimensions(),
                  this.afterSetDimensions(),
              ...
              calculateTickRotation: function () {
                ...
                if (
                  ...
                  for (
                    var u,
                      f,
                      g = e.longestText(i, l, this.ticks, this.longestTextCache),
                      p = g,
                      m = this.getPixelForTick(1) - this.getPixelForTick(0) - 6;
                    p > m && this.labelRotation < o.maxRotation;

                  ) {
                    if (
                      ((u = Math.cos(e.toRadians(this.labelRotation))),
                      (f = Math.sin(e.toRadians(this.labelRotation))),
                      (h = u * d),
                      h + n / 2 > this.yLabelWidth && (this.paddingLeft = h + n / 2),
              ...
              fit: function () {
                ...
                if (
                  (l
                    ? (i.width = this.isFullWidth() ? this.maxWidth - this.margins.left - this.margins.right : this.maxWidth)
                    : (i.width = s ? m : 0),
                  l ? (i.height = s ? m : 0) : (i.height = this.maxHeight),
                  r.display && s && (l ? (i.height += 1.5 * f) : (i.width += 1.5 * f)),
                  n.display && s)
                ) {
                  ...
                  if (l) {
                    ...
                    (this.paddingLeft = 0 !== this.labelRotation ? k * x + 3 : x / 2 + 3),
                      (this.paddingRight = 0 !== this.labelRotation ? S * (h / 2) + 3 : y / 2 + 3);
                  } else {
                    var C = this.maxWidth - i.width,
                      w = n.mirror;
                    w ? (b = 0) : (b += this.options.ticks.padding),
                      C > b ? (i.width += b) : (i.width = this.maxWidth),
                      (this.paddingTop = h / 2),
                ...
                if (a.display) {
                  ...
                  if (((h.fillStyle = m), this.isHorizontal())) {
                    ...
                    if (
                      ((n = !1),
                      g && (F /= 2),
                      (F + c.autoSkipPadding) * this.ticks.length > this.width - (this.paddingLeft + this.paddingRight) &&
                        (n =
                          1 +
                          Math.floor(
                            ((F + c.autoSkipPadding) * this.ticks.length) / (this.width - (this.paddingLeft + this.paddingRight))
                    ...
                    p || (n = !1),
                      e.each(
                        ...
                        function (t, r) {
                          ...
                          if ((!l || s) && void 0 !== t && null !== t) {
                            ...
                            u.display &&
                              (r === ('undefined' != typeof this.zeroLineIndex ? this.zeroLineIndex : 0)
                                ? ((h.lineWidth = u.zeroLineWidth), (h.strokeStyle = u.zeroLineColor), (o = !0))
                                : o && ((h.lineWidth = u.lineWidth), (h.strokeStyle = u.color), (o = !1)),
                              (d += e.aliasPixel(h.lineWidth)),
                              h.beginPath(),
                              u.drawTicks && (h.moveTo(d, _), h.lineTo(d, P)),
                              u.drawOnChartArea && (h.moveTo(d, i.top), h.lineTo(d, i.bottom)),
                              h.stroke()),
                              c.display &&
                                (h.save(),
                                h.translate(f + c.labelOffset, g ? this.top + 12 : 'top' === a.position ? this.bottom - k : this.top + k),
                                h.rotate(-1 * A),
                                (h.font = y),
                                (h.textAlign = g ? 'right' : 'center'),
                                (h.textBaseline = g ? 'middle' : 'top' === a.position ? 'bottom' : 'top'),
                                h.fillText(t, 0, 0),
                                h.restore());
                          }
                        },
                      ...
                      f.display &&
                        ...
                        (h.fillStyle = S),
                        (h.font = D),
                        (r = this.left + (this.right - this.left) / 2),
                        (s = 'bottom' === a.position ? this.bottom - C / 2 : this.top + C / 2),
                        h.fillText(f.labelString, r, s));
                  } else {
                    o = !0;
                    ...
                    if (
                      (e.each(
                        ...
                        function (t, n) {
                          if (void 0 !== t && null !== t) {
                            ...
                            if (
                              (u.display &&
                                (n === ('undefined' != typeof this.zeroLineIndex ? this.zeroLineIndex : 0)
                                  ? ((h.lineWidth = u.zeroLineWidth), (h.strokeStyle = u.zeroLineColor), (o = !0))
                                  : o && ((h.lineWidth = u.lineWidth), (h.strokeStyle = u.color), (o = !1)),
                                (r += e.aliasPixel(h.lineWidth)),
                                h.beginPath(),
                                u.drawTicks && (h.moveTo(T, r), h.lineTo(V, r)),
                                u.drawOnChartArea && (h.moveTo(i.left, r), h.lineTo(i.right, r)),
                                h.stroke()),
                              c.display)
                            ) {
                              var s,
                              ...
                              h.save(),
                                'left' === a.position
                                  ? c.mirror
                                    ? ((s = this.right + c.padding), (h.textAlign = 'left'))
                                    : ((s = this.right - c.padding), (h.textAlign = 'right'))
                                  : c.mirror
                                  ? ((s = this.left - c.padding), (h.textAlign = 'right'))
                                  : ((s = this.left + c.padding), (h.textAlign = 'left')),
                                h.translate(s, l + c.labelOffset),
                                h.rotate(-1 * A),
                                (h.font = y),
                                (h.textBaseline = 'middle'),
                                h.fillText(t, 0, 0),
                      ...
                      var R = 'left' === a.position ? -0.5 * Math.PI : 0.5 * Math.PI;
                      h.save(),
                        h.translate(r, s),
                        h.rotate(R),
                        (h.textAlign = 'center'),
                  ...
                  if (u.drawBorder) {
                    ...
                    this.isHorizontal()
                      ? ((L = B = 'top' === a.position ? this.bottom : this.top), (L += z), (B += z))
                      : ((O = W = 'left' === a.position ? this.right : this.left), (O += z), (W += z)),
                      h.beginPath(),
                      h.moveTo(O, L),
                      h.lineTo(W, B),
                      h.stroke();
          ...
          t.Title = t.Element.extend({
            ...
            fit: function () {
              var i = this,
                ...
                l = i.minSize;
              i.isHorizontal()
                ? ((l.width = i.maxWidth), (l.height = r ? s + 2 * o.padding : 0))
                : ((l.width = r ? s + 2 * o.padding : 0), (l.height = i.maxHeight)),
                (i.width = l.width),
                (i.height = l.height);
            },
            afterFit: i,
            ...
            draw: function () {
              ...
              if (n.display) {
                var s,
                  ...
                  m = i.bottom,
                  b = i.right;
                (a.fillStyle = o(n.fontColor, r.defaultFontColor)),
                  (a.font = u),
                  i.isHorizontal()
                    ? ((s = p + (b - p) / 2), (l = g + (m - g) / 2))
                    : ((s = 'left' === n.position ? p + h / 2 : b - h / 2),
                      (l = g + (m - g) / 2),
          ...
          (t.defaults.global.tooltips = {
            ...
            callbacks: {
              ...
              title: function (t, e) {
                ...
                return (
                  t.length > 0 &&
                    (t[0].xLabel ? (i = t[0].xLabel) : e.labels.length > 0 && t[0].index < e.labels.length && (i = e.labels[t[0].index])),
                  i
                );
              },
              afterTitle: i.noop,
            ...
            (t.Tooltip = t.Element.extend({
              ...
              getBody: function (t, e) {
                ...
                return (
                  i.each(
                    t,
                    function (t) {
                      i.pushAllIfDefined(this._options.tooltips.callbacks.beforeLabel.call(this, t, e), a),
                        i.pushAllIfDefined(this._options.tooltips.callbacks.label.call(this, t, e), a),
                        i.pushAllIfDefined(this._options.tooltips.callbacks.afterLabel.call(this, t, e), a);
                    },
                    this
                  ),
                  a
              ...
              getTooltipSize: function (t) {
                ...
                return (
                  ...
                  (a.height += t.footer.length ? (t.footer.length - 1) * t.footerSpacing : 0),
                  (e.font = i.fontString(t.titleFontSize, t._titleFontStyle, t._titleFontFamily)),
                  i.each(t.title, function (t) {
                    a.width = Math.max(a.width, e.measureText(t).width);
                  }),
                  (e.font = i.fontString(t.bodyFontSize, t._bodyFontStyle, t._bodyFontFamily)),
                  ...
                  i.each(
                    ...
                    function (i) {
                      a.width = Math.max(
                        a.width,
                        e.measureText(i).width + ('single' !== this._options.tooltips.mode ? t.bodyFontSize + 2 : 0)
                      );
                    },
                    this
                  ),
                  (e.font = i.fontString(t.footerFontSize, t._footerFontStyle, t._footerFontFamily)),
              ...
              determineAlignment: function (t) {
                this._model.y < t.height
                  ...
                  : this._model.y > this._chart.height - t.height && (this._model.yAlign = 'bottom');
                var e,
                  i,
                  a,
                  o,
                ...
                'center' === this._model.yAlign
                  ...
                  e(this._model.x)
                    ? ((this._model.xAlign = 'left'),
                      a(this._model.x) && ((this._model.xAlign = 'center'), (this._model.yAlign = n(this._model.y))))
                    : i(this._model.x) &&
                      ((this._model.xAlign = 'right'),
                      o(this._model.x) && ((this._model.xAlign = 'center'), (this._model.yAlign = n(this._model.y))));
              },
              getBackgroundPoint: function (t, e) {
                var i = { x: t.x, y: t.y };
                return (
                  'right' === t.xAlign ? (i.x -= e.width) : 'center' === t.xAlign && (i.x -= e.width / 2),
                  'top' === t.yAlign
                  ...
                  'center' === t.yAlign
                    ? 'left' === t.xAlign
                      ...
                      : 'right' === t.xAlign && (i.x -= t.caretPadding + t.caretSize)
                    : 'left' === t.xAlign
                    ? (i.x -= t.cornerRadius + t.caretPadding)
                    : 'right' === t.xAlign && (i.x += t.cornerRadius + t.caretPadding),
                  i
                );
              },
              drawCaret: function (t, e, a, o) {
                ...
                'center' === c.yAlign
                  ? ('left' === c.xAlign
                      ? ((n = t.x), (r = n - c.caretSize), (s = n))
                      : ((n = t.x + e.width), (r = n + c.caretSize), (s = n)),
                    (h = t.y + e.height / 2),
                    (l = h - c.caretSize),
                    (d = h + c.caretSize))
                  : ('left' === c.xAlign
                      ? ((n = t.x + c.cornerRadius), (r = n + c.caretSize), (s = r + c.caretSize))
                      : 'right' === c.xAlign
                      ? ((n = t.x + e.width - c.cornerRadius), (r = n - c.caretSize), (s = r - c.caretSize))
                      : ((r = t.x + e.width / 2), (n = r - c.caretSize), (s = r + c.caretSize)),
                    'top' === c.yAlign
                      ? ((l = t.y), (h = l - c.caretSize), (d = l))
                      : ((l = t.y + e.height), (h = l + c.caretSize), (d = l)));
              ...
              drawTitle: function (t, e, a, o) {
                if (e.title.length) {
                  ...
                  (a.fillStyle = n.alpha(o * n.alpha()).rgbString()),
                    (a.font = i.fontString(e.titleFontSize, e._titleFontStyle, e._titleFontFamily)),
                    i.each(e.title, function (i, o) {
                      a.fillText(i, t.x, t.y),
                        (t.y += e.titleFontSize + e.titleSpacing),
                        o + 1 === e.title.length && (t.y += e.titleMarginBottom - e.titleSpacing);
                    });
                }
              },
              drawBody: function (t, e, a, o) {
                ...
                (a.fillStyle = n.alpha(o * n.alpha()).rgbString()),
                  (a.font = i.fontString(e.bodyFontSize, e._bodyFontStyle, e._bodyFontFamily)),
                  ...
                  i.each(
                    ...
                    function (n, r) {
                      'single' !== this._options.tooltips.mode &&
                        ((a.fillStyle = i.color(e.legendColorBackground).alpha(o).rgbaString()),
                        a.fillRect(t.x, t.y, e.bodyFontSize, e.bodyFontSize),
                        (a.strokeStyle = i.color(e.labelColors[r].borderColor).alpha(o).rgbaString()),
                        a.strokeRect(t.x, t.y, e.bodyFontSize, e.bodyFontSize),
                        (a.fillStyle = i.color(e.labelColors[r].backgroundColor).alpha(o).rgbaString()),
                        a.fillRect(t.x + 1, t.y + 1, e.bodyFontSize - 2, e.bodyFontSize - 2),
                        (a.fillStyle = i.color(e.bodyColor).alpha(o).rgbaString())),
                        a.fillText(n, t.x + ('single' !== this._options.tooltips.mode ? e.bodyFontSize + 2 : 0), t.y),
              ...
              drawFooter: function (t, e, a, o) {
                if (e.footer.length) {
                  ...
                  (a.fillStyle = n.alpha(o * n.alpha()).rgbString()),
                    (a.font = i.fontString(e.footerFontSize, e._footerFontStyle, e._footerFontFamily)),
              ...
              draw: function () {
                ...
                if (0 !== e.opacity) {
                  ...
                  if (this._options.tooltips.enabled) {
                    ...
                    (t.fillStyle = s.alpha(r * s.alpha()).rgbString()),
                      i.drawRoundedRectangle(t, n.x, n.y, o.width, o.height, e.cornerRadius),
                      t.fill(),
          ...
          (a.elements.arc = { backgroundColor: a.defaultColor, borderColor: '#fff', borderWidth: 2 }),
            (t.elements.Arc = t.Element.extend({
              ...
              inRange: function (t, e) {
                ...
                if (a) {
                  for (
                    var o = i.getAngleFromPoint(a, { x: t, y: e }), n = o.angle, r = o.distance, s = a.startAngle, l = a.endAngle;
                    s > l;
              ...
              draw: function () {
                function t(t) {
                  r._view.skip || s._view.skip
                    ? t && n.lineTo(a._view.scaleZero.x, a._view.scaleZero.y)
                    : n.bezierCurveTo(
                  ...
                  this._children.length > 0 &&
                    ...
                    e.each(
                      ...
                      function (t, i) {
                        ...
                        0 === i
                          ? (this._loop ? n.moveTo(o.scaleZero.x, o.scaleZero.y) : n.moveTo(t._view.x, o.scaleZero),
                            t._view.skip ? this._loop || n.moveTo(r._view.x, this._view.scaleZero) : n.lineTo(t._view.x, t._view.y))
                          : this.lineToNextPoint(
                              ...
                              function (t, e, i) {
                                this._loop
                                  ? n.lineTo(this._view.scaleZero.x, this._view.scaleZero.y)
                                  : (n.lineTo(t._view.x, this._view.scaleZero), n.moveTo(i._view.x, this._view.scaleZero));
                              },
                              function (t, e) {
                                n.lineTo(e._view.x, e._view.y);
                              }
                    ...
                    this._loop
                      ? t(!0)
                      : (n.lineTo(this._children[this._children.length - 1]._view.x, o.scaleZero),
                        n.lineTo(this._children[0]._view.x, o.scaleZero)),
                    (n.fillStyle = o.backgroundColor || i.defaultColor),
                    n.closePath(),
                    n.fill());
                var l = i.elements.line;
                (n.lineCap = o.borderCapStyle || l.borderCapStyle),
                  n.setLineDash && n.setLineDash(o.borderDash || l.borderDash),
                  (n.lineDashOffset = o.borderDashOffset || l.borderDashOffset),
                  (n.lineJoin = o.borderJoinStyle || l.borderJoinStyle),
                  (n.lineWidth = o.borderWidth || l.borderWidth),
                  (n.strokeStyle = o.borderColor || i.defaultColor),
                  n.beginPath(),
                  e.each(
                    this._children,
                    function (t, i) {
                  ...
                  this._loop && this._children.length > 0 && t(),
                  n.stroke(),
                  n.restore();
              },
            }));
            ...
            (t.elements.Point = t.Element.extend({
              ...
              draw: function () {
                var t,
                  ...
                  g = h.y;
                if (!h.skip) {
                  if ('object' == typeof c && ((t = c.toString()), '[object HTMLImageElement]' === t || '[object HTMLCanvasElement]' === t))
                    return void d.drawImage(c, f - c.width / 2, g - c.height / 2);
                  if (!(isNaN(u) || 0 >= u)) {
                    switch (
                      ((d.strokeStyle = h.borderColor || a),
                      (d.lineWidth = e.getValueOrDefault(h.borderWidth, i.elements.point.borderWidth)),
                      (d.fillStyle = h.backgroundColor || a),
                      c)
                    ) {
                      default:
          ...
          (e.elements.rectangle = {
            ...
            (t.elements.Rectangle = t.Element.extend({
              ...
              inRange: function (t, e) {
                ...
                return i
                  ? i.y < i.base
                    ? t >= i.x - i.width / 2 && t <= i.x + i.width / 2 && e >= i.y && e <= i.base
                    : t >= i.x - i.width / 2 && t <= i.x + i.width / 2 && e >= i.base && e <= i.y
                  : !1;
              },
              inLabelRange: function (t) {
                var e = this._view;
            ...
            a = t.Scale.extend({
              determineDataLimits: function () {
                ...
                void 0 !== this.options.ticks.min &&
                  ((t = e.indexOf(this.chart.data.labels, this.options.ticks.min)), (this.minIndex = -1 !== t ? t : this.minIndex)),
                  void 0 !== this.options.ticks.max &&
                    ((t = e.indexOf(this.chart.data.labels, this.options.ticks.max)), (this.maxIndex = -1 !== t ? t : this.maxIndex)),
                  (this.min = this.chart.data.labels[this.minIndex]),
                  (this.max = this.chart.data.labels[this.maxIndex]);
              },
              buildTicks: function (t) {
                this.ticks =
                  0 === this.minIndex && this.maxIndex === this.chart.data.labels.length - 1
                    ? this.chart.data.labels
                    : this.chart.data.labels.slice(this.minIndex, this.maxIndex + 1);
              },
          ...
          var e = t.helpers,
            ...
            a = t.Scale.extend({
              determineDataLimits: function () {
                    ...
                    n.isDatasetVisible(r) &&
                      ...
                      e.each(o.data, function (t, e) {
                        ...
                        isNaN(o) ||
                          ...
                          ((l[e] = l[e] || 0),
                          (u[e] = u[e] || 0),
                          a.relativePoints ? (l[e] = 100) : 0 > o ? ((c = !0), (u[e] += o)) : ((d = !0), (l[e] += o)));
                      });
                  }),
                    e.each(h, function (t) {
                  ...
                  e.each(s, function (a, o) {
                    ...
                    n.isDatasetVisible(o) &&
                      ...
                      e.each(a.data, function (t, e) {
                        ...
                        isNaN(a) ||
                          r.data[e].hidden ||
                          (null === i.min ? (i.min = a) : a < i.min && (i.min = a),
                ...
                void 0 !== o.min ? (i.min = o.min) : void 0 !== o.suggestedMin && (i.min = Math.min(i.min, o.suggestedMin)),
                  void 0 !== o.max ? (i.max = o.max) : void 0 !== o.suggestedMax && (i.max = Math.max(i.max, o.suggestedMax)),
                  i.min === i.max && (i.max++, o.beginAtZero || i.min--);
              },
              buildTicks: function () {
                var i,
                  a = this,
                ...
                l.push(void 0 !== n.max ? n.max : g),
                  ...
                  (a.max = e.max(l)),
                  (a.min = e.min(l)),
                  n.reverse ? (l.reverse(), (a.start = a.max), (a.end = a.min)) : ((a.start = a.min), (a.end = a.max));
              },
              getLabelForIndex: function (t, e) {
              ...
              getPixelForValue: function (t, e, i, a) {
                ...
                return r.isHorizontal()
                  ? ((n = r.width - (s + r.paddingRight)), (o = r.left + (n / c) * (d - h)), Math.round(o + s))
                  : ((n = r.height - (r.paddingTop + l)), (o = r.bottom - l - (n / c) * (d - h)), Math.round(o));
              },
              getValueForPixel: function (t) {
                var e = this,
                  i = e.isHorizontal(),
              ...
              buildTicks: function () {
                for (
                  var t = this,
                    ...
                    o = e.getValueOrDefault,
                    n = (t.ticks = []),
                    r = o(a.min, Math.pow(10, Math.floor(e.log10(t.min))));
                  r < t.max;
                ...
                n.push(h),
                  ...
                  (t.max = e.max(n)),
                  (t.min = e.min(n)),
                  a.reverse ? (n.reverse(), (t.start = t.max), (t.end = t.min)) : ((t.start = t.min), (t.end = t.max));
              },
              convertTicksToLabels: function () {
              ...
              getPixelForValue: function (t, i, a, o) {
                ...
                return (
                  s.isHorizontal()
                    ? 0 === h
                      ? (r = s.left + f)
                      : ((n = s.width - (f + s.paddingRight)), (r = s.left + (n / d) * (e.log10(h) - e.log10(l))), (r += f))
                    : 0 === h
                    ? (r = s.top + c)
                    : ((n = s.height - (c + u)), (r = s.bottom - u - (n / d) * (e.log10(h) - e.log10(l)))),
                  r
                );
              },
              getValueForPixel: function (t) {
                ...
                return (
                  o.isHorizontal()
                    ? ((a = o.width - (o.paddingLeft + o.paddingRight)),
                      (i = o.start * Math.pow(10, ((t - o.left - o.paddingLeft) * n) / a)))
                    : ((a = o.height - (o.paddingTop + o.paddingBottom)),
                      (i = Math.pow(10, ((o.bottom - o.paddingBottom - t) * n) / a) / o.start)),
                  i
                );
              },
            });
            ...
            o = t.Scale.extend({
              ...
              determineDataLimits: function () {
                      ...
                      if (this.chart.isDatasetVisible(i)) {
                        ...
                        e.each(
                          ...
                          function (t, e) {
                            ...
                            isNaN(i) ||
                              a.data[e].hidden ||
                              (null === this.min ? (this.min = i) : i < this.min && (this.min = i),
                              null === this.max ? (this.max = i) : i > this.max && (this.max = i));
                          },
                          this
                        );
                      }
                ...
                void 0 !== this.options.ticks.min
                  ...
                  : void 0 !== this.options.ticks.suggestedMin && (this.min = Math.min(this.min, this.options.ticks.suggestedMin)),
                  void 0 !== this.options.ticks.max
                    ? (this.max = this.options.ticks.max)
                    : void 0 !== this.options.ticks.suggestedMax && (this.max = Math.max(this.max, this.options.ticks.suggestedMax)),
              ...
              buildTicks: function () {
                ...
                var t = e.getValueOrDefault(this.options.ticks.fontSize, i.defaultFontSize),
                  a = Math.min(
                    this.options.ticks.maxTicksLimit ? this.options.ticks.maxTicksLimit : 11,
                ...
                this.ticks.push(void 0 !== this.options.ticks.max ? this.options.ticks.max : s),
                  (this.max = e.max(this.ticks)),
                  (this.min = e.min(this.ticks)),
                  this.options.ticks.reverse
                    ? (this.ticks.reverse(), (this.start = this.max), (this.end = this.min))
              ...
              fit: function () {
                ...
                for (this.ctx.font = v, a = 0; a < this.getValueCount(); a++)
                  (t = this.getPointPosition(a, x)),
                    (o = this.ctx.measureText(this.pointLabels[a] ? this.pointLabels[a] : '').width + 5),
                    0 === a || a === this.getValueCount() / 2
                      ? ((n = o / 2), t.x + n > y && ((y = t.x + n), (r = a)), t.x - n < k && ((k = t.x - n), (l = a)))
                      : a < this.getValueCount() / 2
                      ? t.x + o > y && ((y = t.x + o), (r = a))
                      : a > this.getValueCount() / 2 && t.x - o < k && ((k = t.x - o), (l = a));
                (d = k),
                  ...
                  (u = e.isNumber(u) ? u : 0),
                  (f = e.isNumber(f) ? f : 0),
                  (this.drawingArea = Math.round(x - (f + u) / 2)),
                  ...
                  if (
                          ...
                          if (this.options.ticks.display) {
                            ...
                            if (((t.font = f), this.options.ticks.showLabelBackdrop)) {
                              ...
                              (t.fillStyle = this.options.ticks.backdropColor),
                                t.fillRect(
                                  this.xCenter - g / 2 - this.options.ticks.backdropPaddingX,
                                  r - d / 2 - this.options.ticks.backdropPaddingY,
                                  g + 2 * this.options.ticks.backdropPaddingX,
                                  d + 2 * this.options.ticks.backdropPaddingY
                                );
                            }
                    ...
                    for (var a = this.getValueCount() - 1; a >= 0; a--) {
                      ...
                      0 === a
                        ...
                        ? (t.textAlign = 'left')
                        : (t.textAlign = 'right'),
                        p ? (t.textBaseline = 'middle') : g ? (t.textBaseline = 'bottom') : (t.textBaseline = 'top'),
                        t.fillText(this.pointLabels[a] ? this.pointLabels[a] : '', n.x, n.y);
                    }
                  }
                }
              },
            ...
            var e = t.helpers,
              ...
              n = t.Scale.extend({
                ...
                getMomentStartOf: function (t) {
                  return 'week' === this.options.time.unit && this.options.time.isoWeekday !== !1
                ...
                determineDataLimits: function () {
                  ...
                  this.chart.data.labels && this.chart.data.labels.length > 0
                        ...
                        'object' == typeof i.data[0] && null !== i.data[0]
                          ? e.each(
                              ...
                              function (t, e) {
                                ...
                                i.isValid() &&
                                  (this.options.time.round && i.startOf(this.options.time.round),
                                  n.push(i),
                                  r &&
                                    ((this.firstTick = null !== this.firstTick ? a.min(this.firstTick, i) : i),
                                    (this.lastTick = null !== this.lastTick ? a.max(this.lastTick, i) : i)));
                              },
                              this
                            )
                          : (n = t),
                    ...
                    this.options.time.min && (this.firstTick = this.parseTime(this.options.time.min)),
                    this.options.time.max && (this.lastTick = this.parseTime(this.options.time.max)),
                ...
                buildTicks: function (a) {
                  ...
                  if (((this.ctx.font = s), (this.ticks = []), (this.unitScale = 1), (this.scaleSizeInUnits = 0), this.options.time.unit))
                    (this.tickUnit = this.options.time.unit || 'day'),
                      (this.displayFormat = this.options.time.displayFormats[this.tickUnit]),
                      (this.scaleSizeInUnits = this.lastTick.diff(this.firstTick, this.tickUnit, !0)),
                      (this.unitScale = e.getValueOrDefault(this.options.time.unitStepSize, 1));
                  else {
                    ...
                    for (var g = 0, p = i.units[g]; g < i.units.length; ) {
                      ...
                      (this.scaleSizeInUnits = this.lastTick.diff(this.firstTick, this.tickUnit, !0) + b + v),
                        (this.displayFormat = this.options.time.displayFormats[p.name]);
                    }
                  }
                  var x;
                  if (
                    (this.options.time.min
                      ? (x = this.getMomentStartOf(this.firstTick))
                      : ((this.firstTick = this.getMomentStartOf(this.firstTick)), (x = this.firstTick)),
                      ...
                      function (t, e) {
                        for (var i = 1; i < this.labelMoments[e].length; i++)
                          this.smallestLabelSeparation = Math.min(
                            ...
                            this.labelMoments[e][i].diff(this.labelMoments[e][i - 1], this.tickUnit, !0)
                          );
                      },
                      this
                    ),
                    this.options.time.displayFormat && (this.displayFormat = this.options.time.displayFormat),
                  ...
                  (0 !== C || 0 === this.scaleSizeInUnits) &&
                    (this.options.time.max
                      ? (this.ticks.push(this.lastTick.clone()),
                        (this.scaleSizeInUnits = this.lastTick.diff(this.ticks[0], this.tickUnit, !0)))
                      : (this.ticks.push(this.lastTick.clone()),
                        (this.scaleSizeInUnits = this.lastTick.diff(this.firstTick, this.tickUnit, !0)))),
                    this.ctx.restore();
                },
