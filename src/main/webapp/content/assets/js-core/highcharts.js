...
(function (M, S) {
  ...
  (function (a) {
    ...
    a.Fx.prototype = {
      dSetter: function () {
        var a = this.paths[0],
          ...
          t;
        if (1 === r) l = this.toD;
        else if (u === f.length && 1 > r) for (; u--; ) (t = parseFloat(a[u])), (l[u] = isNaN(t) ? a[u] : r * parseFloat(f[u] - t) + t);
        else l = f;
      ...
      step: function (m) {
        ...
        u.attr && !u.element
          ...
          ? ((this.now = this.end),
            ...
            l && t && t.call(u),
            (m = !1))
          : ((this.pos = r.easing((f - this.startTime) / g)),
      ...
      initPath: function (m, f, l) {
        ...
        function t(a, c) {
          for (var q = (v - a.length) / e; 0 < q && q--; )
            (y = a.slice().splice(a.length / J - e, e * J)),
              (y[0] = c[v - e - q * e]),
              b && ((y[e - 6] = y[e - 2]), (y[e - 5] = y[e - 1])),
              [].splice.apply(a, [a.length / J, 0].concat(y)),
              D && q--;
        }
        f = f || '';
        var g,
    ...
    a.attr = function (m, f, l) {
      ...
      a.isString(f)
        ? a.defined(l)
          ? m.setAttribute(f, l)
          : m && m.getAttribute && (r = m.getAttribute(f))
        : a.defined(f) &&
          a.isObject(f) &&
    ...
    a.createElement = function (m, f, l, r, u) {
      ...
      var t = a.css;
      f && a.extend(m, f);
      u && t(m, { padding: 0, border: 'none', margin: 0 });
      l && t(m, l);
      r && r.appendChild(m);
      return m;
    };
    ...
    a.formatSingle = function (m, f) {
      ...
      /f$/.test(m)
        ? ((l = (l = m.match(l)) ? l[1] : -1),
          null !== f && (f = a.numberFormat(f, l, r.decimalPoint, -1 < m.indexOf(',') ? r.thousandsSep : '')))
        : (f = a.dateFormat(m, f));
      return f;
    };
    ...
    a.normalizeTickInterval = function (m, f, l, r, u) {
      ...
      t = m / l;
      f ||
        ((f = u ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10]),
        !1 === r &&
          (1 === l
    ...
    a.map = function (a, f) {
      for (var l = [], r = 0, m = a.length; r < m; r++) l[r] = f.call(a[r], a[r], r, a);
      return l;
    };
    a.offset = function (a) {
    ...
    a.addEvent = function (m, f, l) {
      ...
      m.addEventListener
        ? m.addEventListener(f, l, !1)
        : m.attachEvent &&
          (m.hcEventsIE || (m.hcEventsIE = {}),
          l.hcGetKey || (l.hcGetKey = a.uniqueKey()),
          (m.hcEventsIE[l.hcGetKey] = r),
          m.attachEvent('on' + f, r));
      u[f] || (u[f] = []);
      u[f].push(l);
      return function () {
        a.removeEvent(m, f, l);
    ...
    a.removeEvent = function (m, f, l) {
      function r(a, b) {
        m.removeEventListener
          ? m.removeEventListener(a, b, !1)
          : m.attachEvent && ((b = m.hcEventsIE[b.hcGetKey]), m.detachEvent('on' + a, b));
      }
      function u() {
        var d, b;
        m.nodeName &&
      ...
      g &&
        (f
          ? ((t = g[f] || []), l ? ((d = a.inArray(l, t)), -1 < d && (t.splice(d, 1), (g[f] = t)), r(f, l)) : (u(), (g[f] = [])))
          : (u(), (m.hcEvents = {})));
    };
    a.fireEvent = function (m, f, l, r) {
      ...
      var t, g;
      l = l || {};
      if (F.createEvent && (m.dispatchEvent || m.fireEvent))
        (u = F.createEvent('Events')), u.initEvent(f, !0, !0), a.extend(u, l), m.dispatchEvent ? m.dispatchEvent(u) : m.fireEvent(f, u);
      else if (u)
        for (
          u = u[f] || [],
            t = u.length,
    ...
    a.animate = function (m, f, l) {
      var r,
        ...
        g,
        d;
      a.isObject(l) || ((d = arguments), (l = { duration: d[2], easing: d[3], complete: d[4] }));
      ...
      a.objectEach(f, function (d, b) {
        ...
        t = null;
        'd' === b
          ? ((g.paths = g.initPath(m, m.d, f.d)), (g.toD = f.d), (r = 0), (t = 1))
          : m.attr
          ? (r = m.attr(b))
          : ((r = parseFloat(a.getStyle(m, b)) || 0), 'opacity' !== b && (u = 'px'));
        t || (t = d);
    ...
    F &&
      ...
      (a.getStyle = function (m, f) {
        ...
        m =
          m.currentStyle[
            f.replace(/\-(\w)/g, function (a, f) {
              return f.toUpperCase();
            })
          ];
        'filter' === f &&
          (m = m.replace(/alpha\(opacity=([0-9]+)\)/, function (a, f) {
            return f / 100;
          }));
        return '' === m ? 1 : a.pInt(m);
      });
    ...
    a.Color.prototype = {
      ...
      init: function (f) {
        ...
        if ((this.input = f = this.names[f && f.toLowerCase ? f.toLowerCase() : ''] || f) && f.stops)
          this.stops = F(f.stops, function (g) {
          ...
          (f &&
            ...
            7 === l
              ? (r = [(f & 16711680) >> 16, (f & 65280) >> 8, f & 255, 1])
              : 4 === l && (r = [((f & 3840) >> 4) | ((f & 3840) >> 8), ((f & 240) >> 4) | (f & 240), ((f & 15) << 4) | (f & 15), 1])),
          !r)
        )
      ...
      brighten: function (a) {
        ...
        else if (A(a) && 0 !== a) for (f = 0; 3 > f; f++) (r[f] += m(255 * a)), 0 > r[f] && (r[f] = 0), 255 < r[f] && (r[f] = 255);
        return this;
      },
      ...
      tweenTo: function (a, l) {
        ...
        a.rgba.length
          ? ((f = this.rgba),
            ...
            (a =
              (m ? 'rgba(' : 'rgb(') +
              Math.round(a[0] + (f[0] - a[0]) * (1 - l)) +
              ',' +
              Math.round(a[1] + (f[1] - a[1]) * (1 - l)) +
              ',' +
              Math.round(a[2] + (f[2] - a[2]) * (1 - l)) +
              (m ? ',' + (a[3] + (f[3] - a[3]) * (1 - l)) : '') +
              ')'))
          : (a = a.input || 'none');
        return a;
  ...
  (function (a) {
    ...
    e(C.prototype, {
      ...
      colorGradient: function (x, h, c) {
        ...
        q &&
          ...
          (k = x.stops),
          (v = c.radialReference),
          J(N) && (x[q] = N = { x1: N[0], y1: N[1], x2: N[2], y2: N[3], gradientUnits: 'userSpaceOnUse' }),
          'radialGradient' === q &&
            v &&
            !t(N.gradientUnits) &&
            ((d = N), (N = p(N, w.getRadialAttr(v, d), { gradientUnits: 'userSpaceOnUse' }))),
          I(N, function (a, x) {
            'id' !== x && z.push(x, a);
          }),
          I(k, function (a) {
          ...
          n[z]
            ? (v = n[z].attr('id'))
            : ((N.id = v = a.uniqueKey()),
              (n[z] = g = w.createElement(q).attr(N).add(w.defs)),
              (g.radAttr = d),
              (g.stops = []),
              b(k, function (x) {
                0 === x[1].indexOf('rgba') ? ((e = a.color(x[1])), (H = e.get('rgb')), (G = e.get('a'))) : ((H = x[1]), (G = 1));
                x = w.createElement('stop').attr({ offset: x[0], 'stop-color': H, 'stop-opacity': G }).add(g);
                g.stops.push(x);
              })),
          (f = 'url(' + w.url + '#' + v + ')'),
          c.setAttribute(h, f),
      ...
      applyTextOutline: function (x) {
        ...
        if ((p = x[0]) && 'none' !== p && a.svg) {
          ...
          b(x, function (a, x) {
            0 === x &&
              (a.setAttribute('x', h.getAttribute('x')),
              (x = h.getAttribute('y')),
              a.setAttribute('y', x || 0),
              null === x && h.setAttribute('y', 0));
            a = a.cloneNode(1);
            m(a, { class: 'highcharts-text-outline', fill: w, stroke: w, 'stroke-width': p, 'stroke-linejoin': 'round' });
            h.insertBefore(a, e);
          });
        }
      },
      attr: function (a, h, c, w) {
        ...
        'string' === typeof a
          ? (q = (this[a + 'Getter'] || this._defaultGetter).call(this, a, p))
          : (I(
              a,
              function (x, h) {
                b = !1;
                w || P(this, h);
                this.symbolName &&
                  /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)$/.test(h) &&
                  (e || (this.symbolAttr(a), (e = !0)), (b = !0));
                !this.rotation || ('x' !== h && 'y' !== h) || (this.doTransform = !0);
                b ||
                  ((N = this[h + 'Setter'] || this._defaultSetter),
                  N.call(this, x, h, p),
                  this.shadows && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(h) && this.updateShadows(h, x, N));
              },
              this
            ),
            this.afterSetters());
      ...
      css: function (a) {
        ...
        d &&
          (x && (a = e(x, c)),
          (p = this.textWidth = a && a.width && 'auto' !== a.width && 'text' === w.nodeName.toLowerCase() && h(a.width)),
          (this.styles = a),
          p && !H && this.renderer.forExport && delete a.width,
          G && !H
            ? r(this.element, a)
            : ((b = function (a, x) {
      ...
      updateTransform: function () {
        ...
        p
          ...
          : e && a.push('rotate(' + e + ' ' + (q.getAttribute('x') || 0) + ' ' + (q.getAttribute('y') || 0) + ')');
      ...
      align: function (a, h, c) {
        ...
        var b, d;
        if (a) {
          if (((this.alignOptions = a), (this.alignByTranslate = h), !c || B(c)))
            (this.alignTo = x = c || 'renderer'), v(p, this), p.push(this), (c = null);
      ...
      getBBox: function (a, h) {
        ...
        void 0 !== n &&
          ...
          (G += ['', h || 0, d, q && q.width, q && q.textOverflow].join()));
        G && !a && (x = N[G]);
        if (!x) {
          if (p.namespaceURI === this.SVG_NS || c.forExport) {
            try {
              (k =
                ...
                (x = p.getBBox ? e({}, p.getBBox()) : { width: p.offsetWidth, height: p.offsetHeight }),
                k && k('');
            } catch (W) {}
          ...
          c.isSVG &&
            ((a = x.width),
            (c = x.height),
            q && '11px' === q.fontSize && 17 === Math.round(c) && (x.height = c = 14),
            h &&
              ((x.width = Math.abs(c * Math.sin(w)) + Math.abs(a * Math.cos(w))),
              (x.height = Math.abs(c * Math.cos(w)) + Math.abs(a * Math.sin(w)))));
          if (G && 0 < x.height) {
      ...
      destroy: function () {
        ...
        a.clipPath &&
          w &&
          (b(w.querySelectorAll('[clip-path]'), function (x) {
      ...
      zIndexSetter: function (a, c) {
        ...
        if (q) {
          ...
          for (d = 0; d < c.length && !b; d++)
            (w = c[d]),
              (q = w.zIndex),
              w !== e && (h(q) > a || (!t(a) && t(q)) || (0 > a && !t(q) && p !== x.box)) && (p.insertBefore(e, w), (b = !0));
          b || p.appendChild(e);
        }
        return b;
      },
    ...
    C.prototype['stroke-widthSetter'] = C.prototype.strokeSetter = function (a, h, c) {
      ...
      this.stroke && this['stroke-width']
        ? (C.prototype.fillSetter.call(this, this.stroke, 'stroke', c),
    ...
    e(A.prototype, {
      ...
      init: function (a, h, w, p, q, e) {
        ...
        this.alignedObjects = [];
        this.url =
          (c || K) && k.getElementsByTagName('base').length
            ? R.location.href
                .replace(/#.*?$/, '')
                .replace(/<[^>]*>/g, '')
                .replace(/([\('\)])/g, '\\$1')
        ...
        c &&
          ...
          ((h = function () {
            ...
            r(a, { left: Math.ceil(b.left) - b.left + 'px', top: Math.ceil(b.top) - b.top + 'px' });
          }),
          h(),
          (this.unSubPixelFix = F(R, 'resize', h)));
      },
      getStyle: function (a) {
        return (this.style = e(
        ...
        if (t !== a.textCache) {
          ...
          q || B || D || f || -1 !== p.indexOf(' ')
            ? ((d = /<.*class="([^"]+)".*>/),
              ...
              b(p, function (h, p) {
                ...
                b(q, function (h) {
                  if ('' !== h || 1 === q.length) {
                    ...
                    g.test(h) && !x && (m(z, 'onclick', 'location.href\x3d"' + h.match(g)[1] + '"'), r(z, { cursor: 'pointer' }));
                    ...
                    if (' ' !== h) {
                      ...
                      m(z, b);
                      c.appendChild(z);
                      !e && J && (!H && x && r(z, { display: 'block' }), m(z, 'dy', K(z)));
                      if (f) {
                        ...
                        for (D && (G = w.applyEllipsis(a, z, h, f)); !D && y && (b.length || B.length); )
                          (a.rotation = 0),
                            ...
                            void 0 === G && (G = h),
                            h && 1 !== b.length
                              ? (z.removeChild(z.firstChild), B.unshift(b.pop()))
                              : ((b = B),
                                (B = []),
                                b.length &&
                                  !l &&
                                  ((z = k.createElementNS(O, 'tspan')), m(z, { dy: P, x: v }), I && m(z, 'style', I), c.appendChild(z)),
                                N > f && (f = N)),
              ...
              z && z.removeChild(c),
              B && a.applyTextOutline && a.applyTextOutline(B))
            : c.appendChild(k.createTextNode(p.replace(/&lt;/g, '\x3c').replace(/&gt;/g, '\x3e')));
        }
      },
      ...
      button: function (a, h, c, w, q, b, d, n, g) {
        var x = this.label(a, h, c, g, null, null, null, null, 'button'),
          k = 0;
        x.attr(p({ padding: 8, r: 2 }, q));
        var z, H, v, f;
        q = p(
          { fill: '#f7f7f7', stroke: '#cccccc', 'stroke-width': 1, style: { color: '#333333', cursor: 'pointer', fontWeight: 'normal' } },
          q
        );
        z = q.style;
        delete q.style;
        ...
        H = b.style;
        delete b.style;
        d = p(q, { fill: '#e6ebf5', style: { color: '#000000', fontWeight: 'bold' } }, d);
        v = d.style;
        delete d.style;
        n = p(q, { style: { color: '#cccccc' } }, n);
        f = n.style;
        delete n.style;
        ...
        x.attr(q).css(e({ cursor: 'default' }, z));
      ...
      arc: function (a, h, c, w, p, b) {
        q(a) ? ((w = a), (h = w.y), (c = w.r), (a = w.x)) : (w = { innerR: w, start: p, end: b });
      ...
      rect: function (a, h, c, w, p, b) {
        ...
        a = q(a) ? a : void 0 === a ? {} : { x: a, y: h, width: Math.max(c, 0), height: Math.max(w, 0) };
      ...
      image: function (a, h, c, w, p) {
        ...
        1 < arguments.length && e(x, { x: h, y: c, width: w, height: p });
      ...
      symbol: function (a, h, c, w, p, q) {
        var x = this,
          ...
          y;
        G
          ? ((d = this.path(H)), d.attr('fill', 'none'), e(d, { symbolName: z, x: h, y: c, width: w, height: p }), q && e(d, q))
          : g &&
            ((v = a.match(n)[1]),
            (d = this.image(v)),
            (d.imgwidth = L(Q[v] && Q[v].width, q && q.width)),
            (d.imgheight = L(Q[v] && Q[v].height, q && q.height)),
            (y = function () {
            ...
            b(['width', 'height'], function (a) {
              d[a + 'Setter'] = function (a, h) {
                ...
                this[h] = a;
                t(w) &&
                  (this.element && this.element.setAttribute(h, w),
                  this.alignByTranslate || ((c[p] = ((this[h] || 0) - w) / 2), this.attr(c)));
              };
            }),
            t(h) && d.attr({ x: h, y: c }),
            (d.isImg = !0),
            t(d.imgwidth) && t(d.imgheight)
              ? y()
              : (d.attr({ width: 0, height: 0 }),
                u('img', {
                  onload: function () {
                    var a = f[x.chartIndex];
                    0 === this.width && (r(this, { position: 'absolute', top: '-999em' }), k.body.appendChild(this));
                    Q[v] = { width: this.width, height: this.height };
      ...
      symbols: {
        ...
        callout: function (a, h, c, w, p) {
          ...
          e && e > c
            ? p > h + b && p < h + w - b
              ? d.splice(13, 3, 'L', a + c, p - 6, a + c + 6, p, a + c, p + 6, a + c, h + w - q)
              : d.splice(13, 3, 'L', a + c, w / 2, e, p, a + c, w / 2, a + c, h + w - q)
            : e && 0 > e
            ? p > h + b && p < h + w - b
              ? d.splice(33, 3, 'L', a, p + 6, a - 6, p, a, p - 6, a, h + q)
              : d.splice(33, 3, 'L', a, w / 2, e, p, a, w / 2, a, h + q)
            : p && p > w && e > a + b && e < a + c - b
            ? d.splice(23, 3, 'L', e + 6, h + w, e, h + w + 6, e - 6, h + w, a + q, h + w)
            : p && 0 > p && e > a + b && e < a + c - b && d.splice(3, 3, 'L', e - 6, h, e, h - 6, e + 6, h, c - q, h);
          return d;
        },
      },
      clipRect: function (h, c, w, p) {
        var q = a.uniqueKey(),
          b = this.createElement('clipPath').attr({ id: q }).add(this.defs);
      ...
      label: function (h, c, q, d, n, g, k, z, G) {
        ...
        T = function () {
          ...
          K &&
            (f ||
              ((H.box = f = x.symbols[d] || N ? x.symbol(d) : x.rect()),
              f.addClass(('button' === G ? '' : 'highcharts-label-box') + (G ? ' highcharts-' + G + '-box' : '')),
              f.add(H),
              (a = U()),
              (h.x = a),
              (h.y = (z ? -u : 0) + a)),
        ...
        Q = function () {
          var a = D + B,
            h;
          h = z ? 0 : u;
          t(r) && y && ('center' === J || 'right' === J) && (a += { center: 0.5, right: 1 }[J] * (r - y.width));
        ...
        H.onAdd = function () {
          v.add(H);
          H.attr({ text: h || 0 === h ? h : '', x: c, y: q });
          f && t(n) && H.attr({ anchorX: n, anchorY: g });
        };
      ...
      htmlUpdateTransform: function () {
        if (this.added) {
          var a = this.renderer,
            ...
            c = { left: 0, center: 0.5, right: 1 }[f],
            G = this.styles;
          F(e, { marginLeft: d, marginTop: g });
          this.shadows &&
            m(this.shadows, function (a) {
              F(a, { marginLeft: d + 1, marginTop: g + 1 });
            });
          this.inverted &&
            m(e.childNodes, function (c) {
              a.invertChild(c, e);
            });
          if ('SPAN' === e.tagName) {
            var q = this.rotation,
            ...
            p !== this.cTT &&
              ((G = a.fontMetrics(e.style.fontSize).b),
              E(q) && this.setSpanRotation(q, c, G),
              F(e, { width: '', whiteSpace: r || 'nowrap' }),
              e.offsetWidth > B &&
                /[ \-]/.test(e.textContent || e.innerText) &&
                F(e, { width: B + 'px', display: 'block', whiteSpace: r || 'normal' }),
              this.getSpanCorrection(e.offsetWidth, G, c, q, f));
            F(e, { left: n + (this.xCorr || 0) + 'px', top: k + (this.yCorr || 0) + 'px' });
            u && (G = e.offsetHeight);
            this.cTT = p;
          }
    ...
    a.svg ||
      ((A = {
        ...
        getSpanCorrection: function (a, b, q, e, d) {
          ...
          d &&
            'left' !== d &&
            ((this.xCorr -= a * q * (0 > c ? -1 : 1)), e && (this.yCorr -= g * q * (0 > n ? -1 : 1)), E(this.element, { textAlign: d }));
        },
          ...
          for (var c = a.length, b = []; c--; )
            k(a[c])
              ...
              : ((b[c] = a[c]),
                !a.isArc ||
                  ('wa' !== a[c] && 'at' !== a[c]) ||
                  (b[c + 5] === b[c + 7] && (b[c + 7] += a[c + 7] > a[c + 5] ? 1 : -1),
                  b[c + 6] === b[c + 8] && (b[c + 8] += a[c + 8] > a[c + 6] ? 1 : -1)));
          return b.join(' ') || 'x';
        },
        clip: function (a) {
          var c = this,
          ...
          a
            ? ((b = a.members),
              ...
              (a = a.getCSS(c)))
            : (c.destroyClip && c.destroyClip(), (a = { clip: c.docMode8 ? 'inherit' : 'rect(auto)' }));
          return c.css(a);
        },
          ...
          if (a) {
            ...
            for (q = 1; 3 >= q; q++)
              (k = 2 * f + 1 - 2 * q),
                ...
                (n = F(d.prepVML(h), null, { left: y(g.left) + v(a.offsetX, 1), top: y(g.top) + v(a.offsetY, 1) })),
                e && (n.cutOff = k + 1),
                (h = ['\x3cstroke color\x3d"', a.color || '#000000', '" opacity\x3d"', D * q, '"/\x3e']),
        ...
        fillSetter: function (a, b, e) {
          ...
          'SPAN' === c
            ? (e.style.color = a)
            : 'IMG' !== c && ((e.filled = 'none' !== a), this.setAttr('fillcolor', this.renderer.color(a, e, b, this)));
        },
        ...
        visibilitySetter: function (a, b, e) {
          'inherit' === a && (a = 'visible');
          this.shadows &&
            u(this.shadows, function (c) {
              c.style[b] = a;
            });
          'DIV' === e.nodeName &&
            ((a = 'hidden' === a ? '-999em' : 0), this.docMode8 || (e.style[b] = a ? 'visible' : 'hidden'), (b = 'top'));
          e.style[b] = a;
        },
      ...
      (A = {
        ...
        clipRect: function (a, e, d, n) {
          ...
          return g(c, {
            ...
            getCSS: function (a) {
              ...
              !h && a.docMode8 && 'DIV' === b && g(w, { width: c + 'px', height: e + 'px' });
              return w;
            },
        ...
        color: function (c, b, e, d) {
          ...
          if (k) {
            ...
            var l,
              ...
              m = function () {
                g = [
                  '\x3cfill colors\x3d"' + G.join(',') + '" opacity\x3d"',
                  y,
                  '" o:opacity2\x3d"',
                  D,
                  '" type\x3d"',
            ...
            if ('fill' === e)
              if ('gradient' === k)
                (e = H.x1 || H[0] || 0),
                  ...
                  (f = H.x2 || H[2] || 0),
                  (H = H.y2 || H[3] || 0),
                  (B = 'angle\x3d"' + (90 - (180 * Math.atan((H - c) / (f - e))) / Math.PI) + '"'),
                  m();
              else {
                var h = H.r,
                  t = 2 * h,
                  ...
                  h = function () {
                    E &&
                      ((M = d.getBBox()),
                      (A += (E[0] - M.x) / M.width - 0.5),
                      (C += (E[1] - M.y) / M.height - 0.5),
                      (t *= E[2] / M.width),
                      (J *= E[2] / M.height));
                    B =
                      'src\x3d"' +
            ...
            n.test(c) && 'IMG' !== b.tagName
              ? ((p = a.color(c)), d[e + '-opacitySetter'](p.get('a'), e, b), (h = p.get('rgb')))
              : ((h = b.getElementsByTagName(e)), h.length && ((h[0].opacity = 1), (h[0].type = 'solid')), (h = c));
          return h;
        },
        prepVML: function (a) {
          var c = this.isIE8;
          a = a.join('');
          c
            ? ((a = a.replace('/\x3e', ' xmlns\x3d"urn:schemas-microsoft-com:vml" /\x3e')),
              (a =
                -1 === a.indexOf('style\x3d"')
                  ? a.replace('/\x3e', ' style\x3d"display:inline-block;behavior:url(#default#VML);" /\x3e')
                  : a.replace('style\x3d"', 'style\x3d"display:inline-block;behavior:url(#default#VML);')))
        ...
        image: function (a, b, e, d, n) {
          ...
          1 < arguments.length && c.attr({ x: b, y: e, width: d, height: n });
          return c;
        },
        createElement: function (a) {
        ...
        invertChild: function (a, b) {
          ...
          E(a, { flip: 'x', left: y(b.width) - (e ? y(e.top) : 1), top: y(b.height) - (e ? y(e.left) : 1), rotation: -90 });
    ...
    a.Tick.prototype = {
      addLabel: function () {
        ...
        A(g)
          ? g && g.attr({ text: l })
          : ((this.labelLength =
              (this.label = g = A(l) && b.enabled ? t.renderer.text(l, 0, 0, b.useHTML).css(m(b.style)).add(a.labelGroup) : null) &&
              g.getBBox().width),
            (this.rotation = 0));
      },
      ...
      handleOverflow: function (a) {
        var r = this.axis,
          ...
          b = this.label,
          e = this.rotation,
          v = { left: 0, center: 0.5, right: 1 }[r.labelAlign],
          y = b.getBBox().width,
          n = r.getSlotWidth(),
          D = n,
          J = 1,
        ...
        if (e)
          0 > e && m - v * y < k
            ? (c = Math.round(m / Math.cos(e * l) - k))
            : 0 < e && m + v * y > d && (c = Math.round((g - m) / Math.cos(e * l)));
        else if (
          ((g = m + (1 - v) * y),
          m - v * y < k ? (D = a.x + D * (1 - v) - k) : g > d && ((D = d - a.x + D * v), (J = -1)),
          (D = Math.min(n, D)),
          D < n && 'center' === r.labelAlign && (a.x += J * (n - D - v * (n - Math.min(y, D)))),
          y > D || (r.autoRotation && (b.styles || {}).width))
        )
          c = D;
      ...
      getPosition: function (a, f, l, g) {
        ...
        return {
          x: a
            ? d.translate(f + l, null, null, g) + d.transB
            : d.left + d.offset + (d.opposite ? ((g && k.oldChartWidth) || k.chartWidth) - d.right - d.left : 0),
        ...
        A(c) ||
          (c =
            0 === v.side
              ...
              : 2 === v.side
              ? r.y + 8
              : Math.cos(m.rotation * l) * (r.y - m.getBBox(!1, 0).height / 2));
        ...
        k ||
          ...
          (this.gridLine = k =
            n
              ...
              .add(g.gridGroup)));
        if (!a && k && (a = g.getPlotLinePath(e + y, k.strokeWidth() * l, a, !0))) k[this.isNew ? 'attr' : 'animate']({ d: a, opacity: f });
      },
          ...
          n &&
            ((this.mark = y =
              k
                ...
                .add(g.axisGroup)),
            y.attr({ stroke: d, 'stroke-width': r })),
          y[n ? 'attr' : 'animate']({ d: this.getMarkPath(D, a, v[0], y.strokeWidth() * m, g.horiz, k), opacity: l }));
      },
      renderLabel: function (a, l, m, g) {
        ...
        e &&
          E(r) &&
          ((e.xy = a = this.getLabelPosition(r, a, e, k, v, n, g, y)),
          (this.isFirst && !this.isLast && !f(b.showFirstLabel, 1)) || (this.isLast && !this.isFirst && !f(b.showLastLabel, 1))
            ? (D = !1)
            : !k || d.isRadial || v.step || v.rotation || l || 0 === m || this.handleOverflow(a),
          y && g % y && (D = !1),
          D && E(a.y)
            ? ((a.opacity = m), e[this.isNewLabel ? 'attr' : 'animate'](a), (this.isNewLabel = !1))
  ...
  var S = (function (a) {
    ...
    a.extend(L.prototype, {
              ...
              (c = h.xData),
                c.length &&
                  ...
                  D(h) ||
                    ...
                    (h = E(c))),
                  (a.dataMin = Math.min(B(a.dataMin, c[0]), h)),
                  (a.dataMax = Math.max(B(a.dataMax, c[0]), F(c))));
            else if (
              (h.getExtremes(),
              (e = h.dataMax),
              (h = h.dataMin),
              r(h) && r(e) && ((a.dataMin = Math.min(B(a.dataMin, h), h)), (a.dataMax = Math.max(B(a.dataMax, e), e))),
              r(w) && (a.threshold = w),
      ...
      getPlotLinePath: function (a, b, c, e, p) {
        ...
        D(p)
          ? this.horiz
            ? ((n = d), (q = g - this.bottom), (a = c = v(a, w, w + this.width)))
            : ((a = w), (c = k - this.right), (n = q = v(n, d, d + this.height)))
          : (f = !0);
      ...
      getMinorTickPositions: function () {
        ...
        if (q && q / e < a.len / 3)
          if (a.isLog)
            g(this.paddedTicks, function (h, b, c) {
              b && p.push.apply(p, a.getLogTickPositions(e, c[b - 1], c[b], !0));
            });
          else if (a.isDatetimeAxis && 'auto' === b.minorTickInterval)
            p = p.concat(a.getTimeTicks(a.normalizeTimeTickInterval(e), n, d, b.startOfWeek));
      ...
      adjustForMinRange: function () {
        ...
        c - b < this.minRange &&
          ...
          (e = (v - c + b) / 2),
          (e = [b - e, B(a.min, b - e)]),
          p && (e[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin),
          (b = F(e)),
          (c = [b + v, B(a.max, b + v)]),
          p && (c[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax),
          (c = E(c)),
          c - b < v && ((e[0] = c - v), (e[1] = B(a.min, c - v)), (b = F(e))));
        this.min = b;
        this.max = c;
      },
      getClosest: function () {
      ...
      setAxisTranslation: function (a) {
        ...
        if (f || q || c)
          (e = h.getClosest()),
            n
              ? ((p = n.minPointOffset), (d = n.pointRangePadding))
      ...
      setTickInterval: function (h) {
        ...
        A = B(b.userMax, p.max);
        v
          ? ((b.linkedParent = c[b.coll][p.linkedTo]),
            (c = b.linkedParent.getExtremes()),
            (b.min = B(c.min, c.dataMin)),
            (b.max = B(c.max, c.dataMax)),
            p.type !== b.linkedParent.options.type && a.error(11, 1))
          : (!t && r(J) && (b.dataMin >= J ? ((L = J), (y = 0)) : b.dataMax <= J && ((u = J), (z = 0))),
            (b.min = B(K, L, b.dataMin)),
            (b.max = B(A, u, b.dataMax)));
        d &&
          (b.positiveValuesOnly && !h && 0 >= Math.min(b.min, B(b.dataMin, b.min)) && a.error(10, 1),
          (b.min = f(n(b.min), 15)),
          (b.max = f(n(b.max), 15)));
        ...
        b.adjustForMinRange();
        !(m || b.axisPointRange || b.usePercentage || v) &&
          r(b.min) &&
          r(b.max) &&
          (n = b.max - b.min) &&
          (!r(K) && y && (b.min -= n * y), !r(A) && z && (b.max += n * z));
        ...
        t &&
          r(b.dataMin) &&
          ((J = J || 0), !r(K) && b.min < J && b.dataMin >= J ? (b.min = J) : !r(A) && b.max > J && b.dataMax <= J && (b.max = J));
        b.tickInterval =
          b.min === b.max || void 0 === b.min || void 0 === b.max
            ? 1
            : v && !l && I === b.linkedParent.options.tickPixelInterval
            ? (l = b.linkedParent.tickInterval)
            : B(
                l,
                this.tickAmount ? (b.max - b.min) / Math.max(this.tickAmount - 1, 1) : void 0,
                m ? 1 : ((b.max - b.min) * I) / Math.max(b.len, I)
              );
        x &&
          !h &&
        ...
        q ||
          ...
          (b.tickInterval = G(
            ...
            null,
            e(b.tickInterval),
            B(p.allowDecimals, !(0.5 < b.tickInterval && 5 > b.tickInterval && 1e3 < b.max && 9999 > b.max)),
            !!this.tickAmount
          ));
      ...
      setTickPositions: function () {
        ...
        this.single =
          this.min === this.max && r(this.min) && !this.tickAmount && (parseInt(this.min, 10) === this.min || !1 !== a.allowDecimals);
      ...
      alignToOthers: function () {
        ...
        !1 === this.chart.options.chart.alignTicks ||
          !1 === c.alignTicks ||
          this.isLog ||
          g(this.chart[this.coll], function (h) {
            var c = h.options,
      ...
      zoom: function (a, b) {
        ...
        if (a !== this.min || b !== this.max)
          this.allowZoomOutside || (r(h) && (a < p && (a = p), a > e && (a = e)), r(c) && (b < p && (b = p), b > e && (b = e))),
      ...
      unsquish: function () {
        ...
        b
          ? (v = !a.staggerLines && !a.step && (r(n) ? [n] : p < B(a.autoRotationLimit, 80) && a.autoRotation)) &&
            g(v, function (a) {
              var b;
              if (a === n || (a && -90 <= a && 90 >= a))
                (k = z(Math.abs(q.h / Math.sin(u * a)))), (b = k + Math.abs(a / 360)), b < f && ((f = b), (d = a), (e = k));
            })
          : a.step || (e = z(q.h));
        this.autoRotation = v;
      ...
      getSlotWidth: function () {
        var a = this.chart,
          ...
          p = a.margin[3];
        return (
          (b && 2 > (c.step || 0) && !c.rotation && ((this.staggerLines || 1) * this.len) / e) ||
      ...
      renderUnsquish: function () {
        ...
        else if (q && ((D = { width: k + 'px' }), !z))
          for (D.textOverflow = 'clip', l = e.length; !n && l--; )
            if (((I = e[l]), (k = p[I].label)))
              k.styles && 'ellipsis' === k.styles.textOverflow
                ? k.css({ textOverflow: 'clip' })
                : p[I].labelLength > q && k.css({ width: q + 'px' }),
                k.getBBox().height > this.len / e.length - (v.h - v.f) && (k.specCss = { textOverflow: 'ellipsis' });
        f.rotation &&
          ((D = { width: (y > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : a.chartHeight) + 'px' }), z || (D.textOverflow = 'ellipsis'));
          ...
          ((p = e.textAlign) ||
            (p = (
              c
                ...
                : { low: h ? 'right' : 'left', middle: 'center', high: h ? 'left' : 'right' }
            )[e.align]),
          (this.axisTitle = b
            .text(e.text, 0, 0, e.useHTML)
            .attr({ zIndex: 7, rotation: e.rotation || 0, align: p })
      ...
      getOffset: function () {
        ...
        a.axisGroup ||
          ((a.gridGroup = c
            ...
            .addClass('highcharts-' + this.coll.toLowerCase() + '-grid ' + (L || ''))
            .add(u)),
          (a.axisGroup = c
            .g('axis')
            .attr({ zIndex: e.zIndex || 2 })
            .addClass('highcharts-' + this.coll.toLowerCase() + ' ' + (L || ''))
            .add(u)),
          (a.labelGroup = c
            .g('axis-labels')
            .attr({ zIndex: m.zIndex || 7 })
            .addClass('highcharts-' + a.coll.toLowerCase() + '-labels ' + (L || ''))
            .add(u)));
        v || a.isLinked
          ? (g(p, function (b, c) {
              a.generateTick(b, c);
            ...
            a.renderUnsquish(),
            !1 === m.reserveSpace ||
              (0 !== k && 2 !== k && { 1: 'left', 3: 'right' }[k] !== a.labelAlign && 'center' !== a.labelAlign) ||
              g(p, function (a) {
        ...
        I &&
          ...
          z &&
            !1 !== I.reserveSpace &&
            ((a.titleOffset = D = a.axisTitle.getBBox()[n ? 'height' : 'width']),
            (y = I.offset),
            (l = r(y) ? 0 : B(I.margin, n ? 5 : 10))));
        a.renderLine();
      ...
      getLinePath: function (a) {
        ...
        return b.renderer.crispLine(
          ['M', e ? this.left : p, e ? h : this.top, 'L', e ? b.chartWidth - this.right : p, e ? h : b.chartHeight - this.bottom],
          a
        );
      },
      renderLine: function () {
      ...
      getTitlePosition: function () {
        ...
        return { x: a ? e + k : b + (n ? this.width : 0) + q + k, y: a ? b + g - (n ? this.height : 0) + q : e + g };
      },
      ...
      renderTick: function (a, b) {
        ...
        if (!c || (a >= this.min && a <= this.max))
          e[a] || (e[a] = new I(this, a)), h && e[a].isNew && e[a].render(b, !0, 0.1), e[a].render(b);
      },
      render: function () {
        var b = this,
          c = b.chart,
        ...
        if (b.hasData() || n)
          b.minorTickInterval &&
            !b.categories &&
            g(b.getMinorTickPositions(), function (a) {
              b.renderMinorTick(a);
            }),
            k.length &&
              (g(k, function (a, c) {
            ...
            r &&
              g(k, function (e, h) {
                ...
                0 === h % 2 &&
                  e < b.max &&
                  u <= b.max + (c.polar ? -B : B) &&
                  (l[e] || (l[e] = new a.PlotLineOrBand(b)),
                  (L = e + B),
                  (l[e].options = { from: p ? d(L) : L, to: p ? d(u) : u, color: r }),
                  l[e].render(),
                  (l[e].isActive = !0));
              }),
            b._addedPlotLB ||
              (g((e.plotLines || []).concat(e.plotBands || []), function (a) {
        ...
        G && (G[G.isPlaced ? 'animate' : 'attr']({ d: this.getLinePath(G.strokeWidth()) }), (G.isPlaced = !0), G[J ? 'show' : 'hide'](!0));
        f &&
          J &&
          ((e = b.getTitlePosition()),
          D(e.y) ? (f[f.isNew ? 'attr' : 'animate'](e), (f.isNew = !1)) : (f.attr('y', -9999), (f.isNew = !0)));
      ...
      redraw: function () {
        this.visible &&
          (this.render(),
          g(this.plotLinesAndBands, function (a) {
            a.render();
          }));
        g(this.series, function (a) {
          a.isDirty = !0;
      ...
      drawCrosshair: function (a, b) {
        ...
        this.crosshair && !1 !== (r(b) || !h)
          ? (h
              ? r(b) && (p = this.isXAxis ? b.plotX : this.len - b.plotY)
              : (p = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos)),
            r(p) && (c = this.getPlotLinePath(b && (this.isXAxis ? b.x : B(b.stackY, b.y)), null, null, null, p) || null),
            r(c)
              ? ((b = this.categories && !this.isRadial),
                d ||
                  ((this.cross = d =
                    this.chart.renderer
                      .path()
                      .addClass('highcharts-crosshair highcharts-crosshair-' + (b ? 'category ' : 'thin ') + e.className)
                      .attr({ zIndex: B(e.zIndex, 2) })
                      .add()),
                  d.attr({ stroke: e.color || (b ? m('#ccd6eb').setOpacity(0.25).get() : '#cccccc'), 'stroke-width': B(e.width, 1) }),
                  e.dashStyle && d.attr({ dashstyle: e.dashStyle })),
                d.show().attr({ d: c }),
                b && !e.width && d.attr({ 'stroke-width': this.transA }),
                (this.cross.e = a))
              : this.hideCrosshair())
          : this.hideCrosshair();
      },
  ...
  (function (a) {
    ...
    C.prototype.getTimeTicks = function (a, b, e, v) {
      ...
      if (m(b)) {
        ...
        if (A.hcTimezoneOffset || A.hcGetTimezoneOffset)
          (p = (!D || !!A.hcGetTimezoneOffset) && (e - b > 4 * d.month || u(b) !== u(e))),
            (c = c.getTime()),
            (t = u(c)),
            (c = new A(c + t));
        D = c.getTime();
          ...
          k.push(D),
            (D =
              q === d.year
                ...
                : !p || (q !== d.day && q !== d.week)
                ? p && q === d.hour
                  ? G(r, v, z, I + b * B, 0, 0, t) - t
                  : D + q * B
                : G(r, v, z + b * B * (q === d.day ? 1 : 7))),
            b++;
        k.push(D);
        q <= d.hour &&
          1e4 > k.length &&
      ...
      k.info = l(a, { higherRanks: n, totalRange: q * B });
      return k;
    };
    C.prototype.normalizeTimeTickInterval = function (a, b) {
      ...
      for (
        n = 0;
        n < e.length && !((b = e[n]), (k = d[b[0]]), (g = b[1]), e[n + 1] && a <= (k * g[g.length - 1] + d[e[n + 1][0]]) / 2);
        n++
      );
      k === d.year && a < 5 * k && (g = [1, 2, 5]);
      a = t(a / k, g, 'year' === b[0] ? Math.max(r(a / k), 1) : 1);
      return { unitRange: k, count: a, unitName: b[0] };
    };
  })(M);
  (function (a) {
    var C = a.Axis,
    ...
    C.prototype.getLogTickPositions = function (a, l, r, u) {
      ...
      if (0.5 <= a) (a = Math.round(a)), (b = this.getLinearTickPositions(a, l, r));
      else if (0.08 <= a)
        for (
          var g = Math.floor(l), e, v, y, n, D, f = 0.3 < a ? [1, 2, 4] : 0.15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9];
          g < r + 1 && !D;
          g++
        )
        ...
        (l = d(l)),
          ...
          (a = m(
            ...
            ((f.tickPixelInterval / (u ? 5 : 1)) * (r - l)) / ((u ? g / this.tickPositions.length : g) || 1)
          )),
          (a = E(a, null, A(a))),
  ...
  (function (a, C) {
    ...
    a.PlotLineOrBand.prototype = {
      render: function () {
        ...
        m
          ? ((q = { stroke: B, 'stroke-width': k.width }), k.dashStyle && (q.dashstyle = k.dashStyle))
          : D && (B && (q.fill = B), k.borderWidth && ((q.stroke = k.borderColor), (q['stroke-width'] = k.borderWidth)));
        z.zIndex = K;
        L += '-' + K;
        (B = g.plotLinesAndBandsGroups[L]) ||
          (g.plotLinesAndBandsGroups[L] = B =
            I.g('plot-' + L)
              .attr(z)
              .add());
        ...
        G && q && q.length
          ...
          : c && (q ? (c.show(), c.animate({ d: q })) : (c.hide(), e && (f.label = e = e.destroy())));
        b && E(b.text) && q && q.length && 0 < g.width && 0 < g.height && !q.flat
          ? ((b = r(
              {
                align: d && D && 'center',
                x: d ? !D && 4 : 10,
      ...
      renderLabel: function (a, g, d, k) {
        ...
        b ||
          ...
          (b.zIndex = k),
          (this.label = b = e.text(a.text, 0, 0, a.useHTML).attr(b).add()),
          b.css(a.style));
        k = [g[1], g[4], d ? g[6] : g[1]];
        g = [g[2], g[5], d ? g[7] : g[2]];
        d = F(k);
        e = F(g);
        b.align(a, !1, { x: d, y: e, width: A(k) - d, height: A(g) - e });
        b.show();
      },
      destroy: function () {
    ...
    a.extend(C.prototype, {
      getPlotBandPath: function (a, g) {
        ...
        k && d
          ? (a && ((k.flat = k.toString() === d.toString()), (e = 0)),
            k.push(
              b && d[4] === k[4] ? d[4] + e : d[4],
              b || d[5] !== k[5] ? d[5] : d[5] + e,
              b && d[1] === k[1] ? d[1] + e : d[1],
    ...
    a.Tooltip.prototype = {
      ...
      getLabel: function () {
        ...
        this.label ||
          (this.split
            ...
            : ((this.label = a
                .label('', 0, 0, k.shape || 'callout', null, null, k.useHTML, null, 'tooltip')
      ...
      getAnchor: function (a, k) {
        ...
        b ||
          ...
          (l /= a.length),
          (m /= a.length),
          (b = [d ? e.plotWidth - m : l, this.shared && !d && 1 < a.length && k ? k.chartY - g : d ? e.plotHeight - l : m]));
      ...
      refresh: function (a, g) {
        ...
        e.enabled &&
          (clearTimeout(this.hideTimer),
          (this.followPointer = u(k)[0].series.tooltipOptions.followPointer),
          (n = this.getAnchor(k, g)),
          (g = n[0]),
          (d = n[1]),
          !f || (k.series && k.series.noSharedTooltip)
            ? (f = k.getLabelConfig())
            : (A(k, function (a) {
                a.setState('hover');
          ...
          (f = b.call(f, this)),
          (c = k.series),
          (this.distance = r(c.tooltipOptions.distance, 16)),
          !1 === f
            ? this.hide()
            : ((b = this.getLabel()),
              this.isHidden && b.attr({ opacity: 1 }).show(),
              this.split
                ? this.renderSplit(f, a)
                : (e.style.width || b.css({ width: this.chart.spacingBox.width }),
                  b.attr({ text: f && f.join ? f.join('') : f }),
                  b.removeClass(/highcharts-color-[\d]+/g).addClass('highcharts-color-' + r(k.colorIndex, c.colorIndex)),
                  b.attr({ stroke: e.borderColor || k.color || c.color || '#666666' }),
                  this.updatePosition({ plotX: g, plotY: d, negative: k.negative, ttBelow: k.ttBelow, h: n[2] || 0 })),
              (this.isHidden = !1)));
      },
      renderSplit: function (d, k) {
        ...
        A(d.slice(0, k.length + 1), function (a, d) {
          if (!1 !== a) {
            d = k[d - 1] || { isHeader: !0, plotX: k[0].plotX };
            var q = d.series || b,
              v = q.tt,
              p = d.series || {},
            ...
            v ||
              (q.tt = v =
                f
                  ...
                  .addClass('highcharts-tooltip-box ' + z)
                  .attr({
                    padding: l.padding,
                    r: l.borderRadius,
            ...
            d.isHeader
              ? ((m = a.height), (p = Math.max(0, Math.min(d.plotX + g.plotLeft - p / 2, g.chartWidth - p))))
              : (p = d.plotX + g.plotLeft - r(l.distance, 16) - p);
            0 > p && (n = !1);
  ...
  (function (a) {
    ...
    a.Pointer.prototype = {
      ...
      normalize: function (a, b) {
        ...
        return r(a, { chartX: Math.round(e), chartY: Math.round(b) });
      },
      ...
      getChartCoordinatesFromPoint: function (a, b) {
        ...
        if (c && e)
          return b
            ? { chartX: c.len + c.pos - a.clientX, chartY: e.len + e.pos - a.plotY }
            : { chartX: a.clientX + c.pos, chartY: a.plotY + e.pos };
      },
      getHoverData: function (b, e, d, c, f, q) {
        ...
        n &&
          (f && !e.noSharedTooltip
            ...
            : v.push(n));
        return { hoverPoint: n, hoverSeries: e, hoverPoints: v };
      },
      runPointActions: function (b, e) {
        ...
        if (n && (n !== d.hoverPoint || (c && c.isHidden))) {
          ...
          d.hoverPoint = n;
          c && c.refresh(g ? v : n, b);
        } else e && c && !c.isHidden && ((n = c.getAnchor([{}], b)), c.updatePosition({ plotX: n[0], plotY: n[1] }));
        this.unDocMouseMove ||
          (this.unDocMouseMove = C(d.container.ownerDocument, 'mousemove', function (b) {
      ...
      scaleGroups: function (a, b) {
        ...
        l(e.series, function (d) {
          ...
          d.xAxis &&
            ...
            d.group &&
            (d.group.attr(c),
            d.markerGroup && (d.markerGroup.attr(c), d.markerGroup.clip(b ? e.clipRect : null)),
            d.dataLabelsGroup && d.dataLabelsGroup.attr(c));
        });
      ...
      drag: function (a) {
        ...
        (h && h.touch) ||
          (c < f ? (c = f) : c > f + k && (c = f + k),
          d < p ? (d = p) : d > p + v && (d = p + v),
          (this.hasDragged = Math.sqrt(Math.pow(w - c, 2) + Math.pow(m - d, 2))),
          10 < this.hasDragged &&
            ((l = b.isInsidePlot(w - f, m - p)),
            b.hasCartesianSeries &&
              ...
              (this.selectionMarker = h =
                b.renderer
                  ...
                  .add()),
            h && g && ((c -= w), h.attr({ width: Math.abs(c), x: (0 < c ? 0 : c) + w })),
            h && n && ((c = d - m), h.attr({ height: Math.abs(c), y: (0 < c ? 0 : c) + m })),
      ...
      drop: function (a) {
          ...
          if (this.hasDragged || c)
            l(e.axes, function (e) {
              if (e.zoomEnabled && f(e.min) && (c || b[{ xAxis: 'zoomX', yAxis: 'zoomY' }[e.coll]])) {
                ...
                d[e.coll].push({ axis: e, min: Math.min(q, h), max: Math.max(q, h) });
                I = !0;
              }
            }),
              I &&
                t(e, 'selection', d, function (a) {
        ...
        e &&
          (m(e.container, { cursor: e._cursor }),
      ...
      onContainerClick: function (a) {
        ...
        b.cancelClick ||
          (e && this.inClass(a.target, 'highcharts-tracker')
            ? (t(e.series, 'click', r(a, { point: e })), b.hoverPoint && e.firePointEvent('click', a))
            : (r(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - c, a.chartY - d) && t(b, 'click', a)));
      },
  ...
  (function (a) {
    ...
    F(a.Pointer.prototype, {
      ...
      pinch: function (a) {
        ...
        'touchstart' === a.type
          ? (A(g, function (a, b) {
            ...
            (k.x = [t[0].chartX, t[1] && t[1].chartX]),
            (k.y = [t[0].chartY, t[1] && t[1].chartY]),
            A(u.axes, function (a) {
              if (a.zoomEnabled) {
            ...
            (l.res = !0))
          : l.followTouchMove && 1 === d
          ? this.runPointActions(l.normalize(a))
          : t.length &&
            (e || (l.selectionMarker = e = F({ destroy: m, touch: !0 }, u.plotBox)),
            l.pinchTranslate(t, g, v, e, n, k),
            (l.hasPinched = b),
            l.scaleGroups(v, n),
      ...
      touch: function (l, m) {
        ...
        1 === l.touches.length
          ? ((l = this.normalize(l)),
            (g = r.isInsidePlot(l.chartX - r.plotLeft, l.chartY - r.plotTop)) && !r.openMenu
              ? (m && this.runPointActions(l),
                'touchmove' === l.type &&
                  ((m = this.pinchDown),
                  (t = m[0] ? 4 <= Math.sqrt(Math.pow(m[0].chartX - l.chartX, 2) + Math.pow(m[0].chartY - l.chartY, 2)) : !1)),
                f(t, !0) && this.pinch(l))
              : m && this.reset())
    ...
    a.Legend.prototype = {
        ...
        d.text &&
          (this.title ||
            (this.title = this.chart.renderer
              .label(d.text, e - 3, e - 4, null, null, null, a.useHTML, null, 'legend-title')
              .attr({ zIndex: 1 })
              .css(d.style)
              .add(this.group)),
      ...
      renderItem: function (a) {
        ...
        L ||
          ((a.legendGroup = d
            ...
            .addClass(
              'highcharts-' +
                ...
                a.colorIndex +
                (A ? ' ' + A : '') +
                (h ? ' highcharts-series-' + a.index : '')
            )
            .attr({ zIndex: 1 })
            .add(this.scrollGroup)),
          (a.legendItem = L =
            d
              .text('', t ? k + l : -l, this.baseline || 0, O)
              .css(r(a.visible ? c : m))
              .attr({ align: t ? 'left' : 'right', zIndex: 2 })
              .add(a.legendGroup)),
          this.baseline ||
            ((k = c.fontSize),
            (this.fontMetrics = d.fontMetrics(k, L)),
          ...
          this.setItemEvents && this.setItemEvents(a, L, O),
          H && this.createCheckboxForItem(a));
        this.colorizeItem(a, a.visible);
        c.width || L.css({ width: (g.itemWidth || g.width || b.spacingBox.width) - P });
        this.setText(a);
        d = L.getBBox();
        ...
        f &&
          this.itemX - q + c > (p || b.spacingBox.width - 2 * q - g.x) &&
          ((this.itemX = q), (this.itemY += I + this.lastLineHeight + z), (this.lastLineHeight = 0));
      ...
      getAllItems: function () {
        ...
        m(this.chart.series, function (b) {
          var e = b && b.options;
          b &&
            u(e.showInLegend, E(e.linkedTo) ? !1 : void 0, !0) &&
      ...
      adjustMargins: function (a, e) {
        ...
        d.floating ||
          m([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function (f, k) {
            f.test(g) &&
              !E(a[k]) &&
              (b[l[k]] = Math.max(
                b[l[k]],
                b.legend[(k + 1) % 2 ? 'legendHeight' : 'legendWidth'] + [1, -1, -1, 1][k] * d[k % 2 ? 'x' : 'y'] + u(d.margin, 12) + e[k]
              ));
          });
      },
      render: function () {
        ...
        a.lastItemY = 0;
        f ||
          ((a.group = f = d.g('legend').attr({ zIndex: 7 }).add()),
          (a.contentGroup = d.g().attr({ zIndex: 1 }).add(f)),
        ...
        c += B;
        u || ((a.box = u = d.rect().addClass('highcharts-legend-box').attr({ r: q.borderRadius }).add(f)), (u.isNew = !0));
        u.attr({ stroke: q.borderColor, 'stroke-width': q.borderWidth || 0, fill: q.backgroundColor || 'none' }).shadow(q.shadow);
        0 < t && 0 < c && (u[u.isNew ? 'attr' : 'animate'](u.crisp({ x: 0, y: 0, width: t, height: c }, u.strokeWidth())), (u.isNew = !1));
        u[l ? 'show' : 'hide']();
        a.legendWidth = t;
        a.legendHeight = c;
        m(k, function (b) {
        ...
        l && f.align(r(q, { width: t, height: c }), !0, 'spacingBox');
      ...
      handleOverflow: function (a) {
        var b = this,
          ...
          L = this.allItems,
          h = function (a) {
            'number' === typeof a ? r.attr({ height: a }) : r && ((b.clipRect = r.destroy()), b.contentGroup.clip());
        ...
        z.length = 0;
        a > d && !1 !== q.enabled
          ? ((this.clipHeight = c = Math.max(d - 20 - this.titleHeight - l, 0)),
            ...
            r || ((r = b.clipRect = g.clipRect(0, l, 9999, 0)), b.contentGroup.clip(r)),
            h(c),
            p ||
              ((this.nav = p = g.g().attr({ zIndex: 1 }).add(this.group)),
              (this.up = g
                .symbol('triangle', 0, 0, t, t)
                .on('click', function () {
                  b.scroll(-1, B);
                })
                .add(p)),
              (this.pager = g.text('', 15, 10).addClass('highcharts-legend-navigation').css(q.style).add(p)),
              (this.down = g
                .symbol('triangle-down', 0, 0, t, t)
                .on('click', function () {
                  b.scroll(1, B);
                })
                .add(p))),
            b.scroll(0),
            (a = d))
          : p && (h(), (this.nav = p.destroy()), this.scrollGroup.attr({ translateY: 1 }), (this.clipHeight = 0));
        return a;
      },
      scroll: function (a, e) {
        var b = this.pages,
        ...
        a > d && (a = d);
        0 < a &&
          (void 0 !== e && t(e, this.chart),
          this.nav.attr({ translateX: c, translateY: g + this.padding + 7 + this.titleHeight, visibility: 'visible' }),
    ...
    a.LegendSymbolMixin = {
      drawRectangle: function (a, e) {
        ...
        e.legendSymbol = this.chart.renderer
          .rect(d ? (a.symbolWidth - b) / 2 : 0, a.baseline - b + 1, d ? b : a.symbolWidth, b, u(a.options.symbolRadius, b / 2))
      ...
      drawLineMarker: function (a) {
        ...
        d &&
          !1 !== d.enabled &&
          ((b = Math.min(u(d.radius, k), k)),
          0 === this.symbol.indexOf('url') && ((d = r(d, { width: f, height: f })), (b = 0)),
          (this.legendSymbol = d =
            l
              .symbol(this.symbol, g / 2 - b, a - b, 2 * b, 2 * b, d)
              .addClass('highcharts-point')
              .add(c)),
          (d.isMarker = !0));
      },
    };
    (/Trident\/7\.0/.test(d.navigator.userAgent) || f) &&
      k(a.Legend.prototype, 'positionItem', function (a, e) {
        var b = this,
          d = function () {
  ...
  (function (a) {
    ...
    b(R.prototype, {
      ...
      redraw: function (c) {
        ...
        if (q) for (c = d.length; c--; ) (z = d[c]), z.options.stacking && (z.isDirty = !0);
        k(d, function (a) {
      ...
      setTitle: function (a, b, c) {
        var e = this,
          d = e.options,
          h;
        h = d.title = B({ style: { color: '#333333', fontSize: d.isStock ? '16px' : '18px' } }, d.title, a);
        d = d.subtitle = B({ style: { color: '#666666' } }, d.subtitle, b);
        k(
          [
            ['title', a, h],
            ['subtitle', b, d],
        ...
        k(
          ...
          function (a) {
            ...
            e &&
              ...
              e.css({ width: (p.width || h.width + p.widthAdjust) + 'px' }).align(b({ y: a + g }, p), !1, 'spacingBox'),
              p.floating || p.verticalAlign || (c = Math.ceil(c + e.getBBox(p.useHTML).height)));
          },
          this
        );
      ...
      getContainer: function () {
        ...
        this.container = e = l('div', { id: f }, k, e);
      ...
      reflow: function (a) {
        ...
        if (!h && !b.isPrinting && p && c && (e === O || e === m)) {
          if (p !== b.containerWidth || c !== b.containerHeight)
      ...
      setSize: function (b, c, e) {
        ...
        d.getChartSize();
        b = h.globalAnimation;
        (b ? A : g)(d.container, { width: d.chartWidth + 'px', height: d.chartHeight + 'px' }, b);
        d.setChartSize(!0);
      ...
      setChartSize: function (a) {
        ...
        this.spacingBox = e.spacingBox = { x: g[3], y: g[0], width: d - g[3] - g[1], height: h - g[0] - g[2] };
        this.plotBox = e.plotBox = { x: q, y: n, width: l, height: z };
      ...
      drawChartBox: function () {
        ...
        d[y]({ x: n / 2, y: n / 2, width: c - n - (g % 2), height: e - n - (g % 2), r: a.borderRadius });
        y = 'animate';
        h || ((y = 'attr'), (this.plotBackground = h = b.rect().addClass('highcharts-plot-background').add()));
        h[y](v);
        h.attr({ fill: q || 'none' }).shadow(a.plotShadow);
        l && (f ? f.animate(v) : (this.plotBGImage = b.image(l, z, m, w, I).add()));
        r ? r.animate({ width: B.width, height: B.height }) : (this.clipRect = b.clipRect(B));
        y = 'animate';
        ...
        p[y](p.crisp({ x: z, y: m, width: w, height: I }, -p.strokeWidth()));
        this.isDirtyBox = !1;
      },
      ...
      linkSeries: function () {
        ...
        k(b, function (b) {
          ...
          c(e) &&
            ...
            e.linkedParent !== b &&
            (e.linkedSeries.push(b), (b.linkedParent = e), (b.visible = z(b.options.visible, e.options.visible, b.visible)));
        });
      },
      ...
      isReadyToRender: function () {
        var a = this;
        return P || O != O.top || 'complete' === m.readyState
          ? !0
    ...
    a.Point.prototype = {
      ...
      optionsToObject: function (a) {
        ...
        if (r(a) || null === a) d[e[0]] = a;
          ...
          for (!b && a.length > f && ((g = typeof a[0]), 'string' === g ? (d.name = a[0]) : 'number' === g && (d.x = a[0]), m++); n < f; )
      ...
      },
      {
        ...
        bindAxes: function () {
          ...
          t(b.axisTypes || [], function (h) {
            t(e[h], function (a) {
              d = a.options;
              if (c[h] === d.index || (void 0 !== c[h] && c[h] === d.id) || (void 0 === c[h] && 0 === d.index))
        ...
        autoIncrement: function () {
          ...
          e &&
            ...
            'day' === e
              ...
              : 'year' === e && (a = +a[f.hcSetFullYear](a[f.hcGetFullYear]() + c)),
            (c = a - b));
          this.xIncrement = b + c;
          return b;
        },
        setOptions: function (a) {
          ...
          this.stickyTracking = J(
            a.stickyTracking,
            d[this.type] && d[this.type].stickyTracking,
            d.series && d.series.stickyTracking,
        ...
        getCyclic: function (a, b, c) {
          ...
          b ||
            ((e = J(p[f], p['_' + f])), u(e) || (d.series.length || (d[g] = 0), (p['_' + f] = e = d[g] % k), (d[g] += 1)), c && (b = c[e]));
          void 0 !== e && (this[f] = e);
          this[a] = b;
        },
        getColor: function () {
          this.options.colorByPoint
            ...
            : this.getCyclic('color', this.options.color || r[this.type].color, this.chart.options.colors);
        },
        getSymbol: function () {
        ...
        setData: function (b, c, d, f) {
          ...
          k = b.length;
          c = J(c, !0);
          if (!1 !== f && k && g === k && !h.cropped && !h.hasGroupedData && h.visible)
            t(b, function (a, b) {
            ...
            if (z && k > z) {
              ...
              if (v(n)) for (d = 0; d < k; d++) (r[d] = this.autoIncrement()), (B[d] = b[d]);
              else if (e(n))
                if (I) for (d = 0; d < k; d++) (n = b[d]), (r[d] = n[0]), (B[d] = n.slice(1, I + 1));
                else for (d = 0; d < k; d++) (n = b[d]), (r[d] = n[0]), (B[d] = n[1]);
              else a.error(12);
            } else
              for (d = 0; d < k; d++)
                void 0 !== b[d] &&
                  ((n = { series: h }), h.pointClass.prototype.applyOptions.apply(n, [b[d]]), h.updateParallelArrays(n, d));
            y(B[0]) && a.error(14, !0);
            h.data = [];
        ...
        processData: function (b) {
          ...
          if (l && this.sorted && !n && (!k || d > k || this.forceCrop))
            ...
            else if (c[0] < v || c[d - 1] > r)
              (h = this.cropData(this.xData, this.yData, v, r)), (c = h.xData), (e = h.yData), (h = h.start), (p = !0);
          for (k = c.length || 1; --k; )
            (d = m ? q(c[k]) - q(c[k - 1]) : c[k] - c[k - 1]),
        ...
        generatePoints: function () {
          ...
          for (r = 0; r < k; r++)
            (n = q + r),
              l
                ? ((m = new f().init(this, [d[r]].concat(G(g[r])))), (m.dataGroup = this.groupMap[r]))
                : (m = c[n]) || void 0 === b[n] || (c[n] = m = new f().init(this, b[n], d[r])),
              m && ((m.index = n), (v[r] = m));
          this.options.keys = a;
          if (c && (k !== (e = c.length) || l))
            for (r = 0; r < e; r++) r !== q || l || (r += k), c[r] && (c[r].destroyElements(), (c[r].plotX = void 0));
          this.data = c;
          this.points = v;
        },
        getExtremes: function (a) {
          ...
          for (l = 0; l < d; l++)
            if (
              ((q = c[l]),
              (n = a[l]),
              (k = (v(n, !0) || e(n)) && (!b.positiveValuesOnly || n.length || 0 < n)),
              (q = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || ((c[l] || q) >= g && (c[l] || q) <= f)),
              k && q)
            )
              if ((k = n.length)) for (; k--; ) null !== n[k] && (h[p++] = n[k]);
              else h[p++] = n;
          this.dataMin = E(h);
          this.dataMax = F(h);
        },
        translate: function () {
          ...
          for (a = 0; a < f; a++) {
            ...
            b &&
              ...
              E &&
              E[A] &&
              ((G = this.getStackIndicator(G, A, this.index)),
              (F = E[A]),
              (C = F.points[G.key]),
              (y = C[0]),
              (C = C[1]),
              y === r && G.key === E[A].base && (y = J(l, d.min)),
              d.positiveValuesOnly && 0 >= y && (y = null),
              (K.total = K.stackTotal = F.total),
              (K.percentage = F.total && (K.y / F.total) * 100),
              (K.stackY = C),
        ...
        setClip: function (a) {
          var b = this.chart,
            ...
            q = b[f + 'm'];
          k ||
            (a && ((g.width = 0), (b[f + 'm'] = q = e.clipRect(-99, d ? -b.plotLeft : -b.plotTop, 99, d ? b.chartWidth : b.chartHeight))),
            (b[f] = k = e.clipRect(g)),
            (k.count = { length: 0 }));
          ...
          a ||
            ...
            0 === k.count.length && f && b[f] && (p || (b[f] = b[f].destroy()), b[f + 'm'] && (b[f + 'm'] = b[f + 'm'].destroy())));
        },
        animate: function (a) {
          var b = this.chart,
          ...
          if (!1 !== g.enabled || this._hasPointMarkers)
            for (e = 0; e < a.length; e++)
              (d = a[e]),
                ...
                (l = d.isInside),
                n && v(c) && null !== d.y
                  ? ((c = J(k.symbol, this.symbol)),
                    (d.hasImage = 0 === c.indexOf('url')),
                    (n = this.markerAttribs(d, d.selected && 'select')),
                    f
                      ? f[l ? 'show' : 'hide'](!0).animate(n)
                      : l &&
                        (0 < n.width || d.hasImage) &&
                        (d.graphic = f = b.renderer.symbol(c, n.x, n.y, n.width, n.height, q ? k : g).add(m)),
                    f && f.attr(this.pointAttribs(d, d.selected && 'select')),
        ...
        pointAttribs: function (a, b) {
          ...
          b &&
            ...
            (e = J(b.lineWidth, c.lineWidth, e + J(b.lineWidthPlus, c.lineWidthPlus, 0))),
            (a = b.fillColor || c.fillColor || a),
            (f = b.lineColor || c.lineColor || f));
          return { stroke: f, 'stroke-width': e, fill: a };
        },
        destroy: function () {
          var a = this,
            b = a.chart,
              ...
              : (0 === g || q
                  ...
                  ? ((g =
                      1 === f
                        ? ['L', m.plotX, l]
                        : 2 === f
                        ? ['L', (m.plotX + n) / 2, m.plotY, 'L', (m.plotX + n) / 2, l]
                        : ['L', n, m.plotY]),
                    g.push('L', n, l))
                  : (g = ['L', n, l]),
                k.push(h.x),
        ...
        drawGraph: function () {
          ...
          t(e, function (e, d) {
            var h = e[0],
              f = a[h];
            f
              ? ((f.endX = c.xMap), f.animate({ d: c }))
              : c.length &&
                ((a[h] = a.chart.renderer.path(c).addClass(e[1]).attr({ zIndex: 1 }).add(a.group)),
                (f = { stroke: e[2], 'stroke-width': b.lineWidth, fill: (a.fillGraph && a.color) || 'none' }),
        ...
        applyZones: function () {
          ...
          e.length &&
            ...
            t(e, function (e, h) {
              ...
              D = Math.max(d, f);
              m.isXAxis
                ? ((k = { x: B ? D : G, y: 0, width: u, height: l }), y || (k.x = b.plotHeight - k.x))
                : ((k = { x: 0, y: B ? D : G, width: l, height: u }), y && (k.y = b.plotWidth - k.y));
              B &&
                c.isVML &&
                (k = m.isXAxis
                  ? { x: 0, y: v ? G : D, height: k.width, width: b.chartWidth }
        ...
        invertGroups: function (a) {
          function b() {
            t(['group', 'markerGroup'], function (b) {
              c[b] &&
                (e.renderer.isVML && c[b].attr({ width: c.yAxis.len, height: c.xAxis.len }),
        ...
        redraw: function () {
          ...
          c &&
            ...
            c.animate({ translateX: J(e && e.left, a.plotLeft), translateY: J(d && d.top, a.plotTop) }));
          this.translate();
          this.render();
        ...
        searchPoint: function (a, b) {
          ...
          return this.searchKDTree(
            { clientX: d ? c.len - a.chartY + c.pos : a.chartX - c.pos, plotY: d ? e.len - a.chartX + e.pos : a.chartY - e.pos },
            b
          );
        },
          ...
          function a(c, e, d) {
            ...
            if ((f = c && c.length))
              return (
                ...
                (f = Math.floor(f / 2)),
                { point: c[f], left: a(c.slice(0, f), e + 1, d), right: a(c.slice(f + 1), e + 1, d) }
              );
          }
  ...
  (function (a) {
    ...
    a.StackItem.prototype = {
      ...
      render: function (a) {
        ...
        this.label
          ...
          : (this.label = this.axis.chart.renderer
              .text(f, null, null, d.useHTML)
              .css(d.style)
              .attr({ align: this.textAlign, rotation: d.rotation, visibility: 'hidden' })
              .add(a));
      },
      setOffset: function (a, d) {
        ...
        if ((d = this.label))
          d.align(this.alignOptions, null, e),
            (e = d.alignAttr),
      ...
      getStackBox: function (a, d, f, b, e, l) {
        ...
        return { x: k ? (d ? b : b - l) : f, y: k ? a - f - e : d ? a - b - l : a - b, width: k ? l : e, height: k ? e : l };
      },
    };
    A.prototype.getStacks = function () {
      ...
      f(a.series, function (d) {
        !d.options.stacking ||
          ...
          (d.stackKey = d.type + u(d.options.stack, ''));
      });
    };
      ...
      if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
        ...
        for (A = 0; A < b; A++)
          (h = f[A]),
            ...
            q[z][h] ||
              (B[z] && B[z][h]
                ? ((q[z][h] = B[z][h]), (q[z][h].total = null))
                : (q[z][h] = new a.StackItem(G, G.options.stackLabels, p, h, n))),
            (z = q[z][h]),
            null !== w &&
              ((z.points[I] = z.points[this.index] = [u(z.cum, m)]),
              E(z.cum) || (z.base = I),
              (z.touched = G.stacksTouched),
              0 < K.index && !1 === this.singleStacks && (z.points[I][0] = z.points[this.index + ',' + h + ',0'][0])),
            'percent' === e
              ? ((p = p ? r : t),
                c && q[p] && q[p][h]
                  ? ((p = q[p][h]), (z.total = p.total = Math.max(p.total, z.total) + Math.abs(w) || 0))
                  : (z.total = F(z.total + (Math.abs(w) || 0))))
              : (z.total = F(z.total + (w || 0))),
            (z.cum = u(z.cum, m) + (w || 0)),
    ...
    t.prototype.setPercentStacks = function () {
      ...
      f([d, '-' + d], function (d) {
        for (var f = b.length, g, l; f--; )
          if (((g = b[f]), (e = a.getStackIndicator(e, g, a.index, d)), (g = (l = k[d] && k[d][g]) && l.points[e.key])))
            (l = l.total ? 100 / l.total : 0), (g[0] = F(g[0] * l)), (g[1] = F(g[1] * l)), (a.stackedYData[f] = g[1]);
      });
    };
    t.prototype.getStackIndicator = function (a, d, f, b) {
      !E(a) || a.x !== d || (b && a.key !== b) ? (a = { x: d, index: 0, key: b }) : a.index++;
  ...
  (function (a) {
    ...
    u(a.Chart.prototype, {
      addSeries: function (a, b, c) {
        ...
        a &&
          ((b = y(b, !0)),
          t(d, 'addSeries', { options: a }, function () {
            e = d.initSeries(a);
            d.isDirtyLegend = !0;
            d.linkSeries();
            b && d.redraw(c);
      ...
      addAxis: function (a, b, c, d) {
        var f = b ? 'xAxis' : 'yAxis',
          g = this.options;
        a = e(a, { index: this[f].length, isX: b });
        b = new F(this, a);
        g[f] = G(g[f] || {});
        g[f].push(a);
        y(c, !0) && this.redraw(d);
      ...
      showLoading: function (a) {
        ...
        e ||
          ((b.loadingDiv = e = E('div', { className: 'highcharts-loading highcharts-loading-hidden' }, null, b.container)),
          (b.loadingSpan = E('span', { className: 'highcharts-loading-inner' }, null, e)),
          C(b, 'redraw', f));
        e.className = 'highcharts-loading';
        b.loadingSpan.innerHTML = a || c.lang.loading;
        m(e, u(d.style, { zIndex: 10 }));
        m(b.loadingSpan, d.labelStyle);
        b.loadingShown || (m(e, { opacity: 0, display: '' }), A(e, { opacity: d.style.opacity || 0.5 }, { duration: d.showDuration || 0 }));
        b.loadingShown = !0;
        f();
      },
    ...
    u(n.prototype, {
      update: function (a, b, c, e) {
        function d() {
          ...
          k(a, !0) &&
            (h && h.element && a && a.marker && void 0 !== a.marker.symbol && (f.graphic = h.destroy()),
    ...
    u(D.prototype, {
      ...
      update: function (a, b) {
        ...
        a = e(f, m, { index: c.index, pointStart: c.xData[0] }, { data: c.options.data }, a);
        c.remove(!1, null, !1);
          ...
          if (this.options.stacking) {
            ...
            A(m, function (a, c) {
              ...
              if (k[a] && !k[a].isNull)
                ...
                l.push({ isNull: !0, plotX: t.translate(a, 0, 0, 0, 1), x: a, plotY: e, yBottom: e });
              }
            });
          }
          return l;
        ...
        getGraphPath: function (a) {
          var f = m.prototype.getGraphPath,
            ...
            G = function (c, d, f) {
              ...
              void 0 !== q &&
                (e.push({ plotX: y, plotY: null === q ? A : g.getThreshold(q), isNull: k, isCliff: !0 }),
                b.push({ plotX: y, plotY: null === m ? A : g.getThreshold(m), doCurve: !1 }));
            };
          a = a || this.points;
          t && (a = this.getStackPoints(a));
          for (d = 0; d < a.length; d++)
            if (((k = a[d].isNull), (y = E(a[d].rectPlotX, a[d].plotX)), (c = E(a[d].yBottom, A)), !k || l))
              l || G(d, d - 1, 'left'), (k && !t && l) || (e.push(a[d]), b.push({ x: d, plotX: y, plotY: c })), l || G(d, d + 1, 'right');
          d = f.call(this, e, !0, !0);
          b.reversed = !0;
          k = f.call(this, b, !0, !0);
          k.length && (k[0] = 'L');
        ...
        drawGraph: function () {
          ...
          A(t, function (g) {
            var d = g[0],
              k = a[d];
            k
              ? ((k.endX = f.xMap), k.animate({ d: f }))
              : ((k = a[d] =
                  a.chart.renderer
                    .path(f)
                    .addClass(g[1])
                    .attr({ fill: E(g[3], C(g[2]).setOpacity(E(u.fillOpacity, 0.75)).get()), zIndex: 0 })
                    .add(a.group)),
                (k.isArea = !0));
            k.startX = f.xMap;
  ...
  (function (a) {
    ...
    u(
      ...
      'line',
      {
        ...
        cropThreshold: 50,
        pointRange: null,
        states: { hover: { halo: !1, brightness: 0.1, shadow: !1 }, select: { color: '#cccccc', borderColor: '#000000', shadow: !1 } },
      ...
      },
      {
        ...
        getColumnMetrics: function () {
          ...
          !1 === d.grouping
            ...
            : F(a.chart.series, function (c) {
                ...
                c.type !== a.type ||
                  ...
                  b.len !== d.len ||
                  b.pos !== d.pos ||
                  (e.stacking ? ((m = c.stackKey), void 0 === r[m] && (r[m] = n++), (f = r[m])) : !1 !== e.grouping && (f = n++),
                  (c.columnIndex = f));
              });
          ...
          a.columnMetrics = { width: d, offset: (c - d) / 2 + (u + ((a.columnIndex || 0) + (e ? 1 : 0)) * c - t / 2) * (e ? -1 : 1) };
        ...
        crispCol: function (a, d, f, b) {
          ...
          b -= d;
          k && b && (--d, (b += 1));
          return { x: a, y: d, width: f, height: b };
        },
        translate: function () {
          var a = this,
            d = a.chart,
          ...
          F(a.points, function (b) {
            ...
            Math.abs(y) < t &&
              t &&
              ((y = t),
              (v = (!e.reversed && !b.negative) || (e.reversed && b.negative)),
              (r = Math.abs(r - m) > t ? f - t : m - (v ? t : 0)));
            b.barX = k;
            b.pointWidth = u;
            b.tooltipPos = d.inverted
              ? [e.len + e.pos - d.plotLeft - g, a.xAxis.len - k - n / 2, y]
              : [k + n / 2, g + e.pos - d.plotTop, y];
            b.shapeType = 'rect';
        ...
        pointAttribs: function (a, d) {
          ...
          d &&
            ((a = f(g.states[d], (a.options.states && a.options.states[d]) || {})),
            (d = a.brightness),
            (m = a.color || (void 0 !== d && A(m).brighten(a.brightness).get()) || m),
            (n = a[b] || n),
            (r = a[l] || r),
            (e = a.dashStyle || e));
          b = { fill: m, stroke: n, 'stroke-width': r };
          e && (b.dashstyle = e);
          return b;
        },
        drawPoints: function () {
          ...
          F(a.points, function (g) {
            ...
            if (m(g.plotY) && null !== g.y) {
              ...
              k.borderRadius && n.attr({ r: k.borderRadius });
        ...
        animate: function (a) {
          ...
          t &&
            (a
              ? ((g.scaleY = 0.001),
                (a = Math.min(f.pos + f.len, Math.max(f.pos, f.toPixels(b.threshold)))),
                e ? (g.translateX = a - f.len) : (g.translateY = a),
                d.group.attr(g))
              : ((g[e ? 'translateX' : 'translateY'] = f.pos),
                d.group.animate(
                  g,
                  E(C(d.options.animation), {
                    step: function (a, b) {
                      d.group.attr({ scaleY: Math.max(0.001, b.pos) });
                    },
                  })
                ),
                (d.animate = null)));
    ...
    t(
      ...
      },
      {
          ...
          a ||
            (F(b, function (a) {
              ...
              b &&
                ...
                b.animate({ r: f.r, start: f.start, end: f.end }, d.options.animation));
            }),
            (d.animate = null));
        },
        ...
        translate: function (a) {
          ...
          for (u = 0; u < p; u++) {
            ...
            z.slicedTranslation = { translateX: Math.round(Math.cos(m) * e), translateY: Math.round(Math.sin(m) * e) };
            n = (Math.cos(m) * a[2]) / 2;
            q = (Math.sin(m) * a[2]) / 2;
        ...
        drawPoints: function () {
          ...
          F(a.points, function (d) {
            if (!d.isNull) {
              ...
              e
                ? e.setRadialReference(a.center).attr(g).animate(E(l, b))
                : ((d.graphic = e = f[d.shapeType](l).setRadialReference(a.center).attr(b).add(a.group)),
                  d.visible || e.attr({ visibility: 'hidden' }),
                  e.attr(g).attr({ 'stroke-linejoin': 'round' }).shadow(n, k));
      ...
      },
      {
        ...
        setVisible: function (a, f) {
          ...
          f = l(f, g);
          a !== b.visible &&
            ((b.visible = b.options.visible = a = void 0 === a ? !b.visible : a),
            (e.options.data[m(b, e.data)] = b.options),
            F(['graphic', 'dataLabel', 'connector', 'shadowGroup'], function (e) {
  ...
  (function (a) {
      ...
      for (
        ...
        for (g = !1; f--; )
          0 < f &&
            ...
            a[f - 1].pos + a[f - 1].size > d && (a[f - 1].pos = d - a[f - 1].size),
            a.splice(f, 1),
            (g = !0));
      }
      f = 0;
    ...
    d.prototype.drawDataLabels = function () {
      var b = this,
        ...
        A = b.chart.renderer;
      if (g.enabled || b._hasPointLabels)
        b.dlProcessOptions && b.dlProcessOptions(g),
          ...
          E(k, function (c) {
            ...
            if ((e = t(l && l.enabled, m.enabled) && null !== c.y))
              (g = r(m, l)),
                (n = c.getLabelConfig()),
                ...
                'contrast' === B.color &&
                  ((c.contrastColor = A.getContrast(c.color || b.color)),
                  (B.color = g.inside || 0 > t(c.labelDistance, g.distance) || d.stacking ? c.contrastColor : '#000000')),
            ...
            !k || (e && F(u))
              ? e &&
                ...
                (k
                  ? (h.text = u)
                  : ((k = c.dataLabel = A[n ? 'text' : 'label'](u, 0, -9999, g.shape, null, null, g.useHTML, null, 'data-label')),
                    k.addClass(
                      'highcharts-data-label-color-' + c.colorIndex + ' ' + (g.className || '') + (g.useHTML ? 'highcharts-tracker' : '')
                    )),
                k.attr(h),
                k.css(B).shadow(g.shadow),
                k.added || k.add(q),
                b.alignDataLabel(c, k, g, null, v))
              : ((c.dataLabel = k = k.destroy()), p && (c.connector = p.destroy()));
          });
    };
    d.prototype.alignDataLabel = function (a, b, d, f, g) {
      var e = this.chart,
        ...
        u =
          this.visible &&
          (a.series.forceDL || e.isInsidePlot(k, Math.round(l), c) || (f && e.isInsidePlot(k, c ? f.x + 1 : f.y + f.height - 1, c))),
        y = 'justify' === t(d.overflow, 'justify');
      if (
        u &&
        ((r = d.style.fontSize),
        (r = e.renderer.fontMetrics(r, b).b),
        (f = m({ x: c ? this.yAxis.len - l : k, y: Math.round(c ? this.xAxis.len - k : l), width: 0, height: 0 }, f)),
        m(d, { width: n.width, height: n.height }),
        p
          ? ((y = !1),
            (k = e.renderer.rotCorr(r, p)),
            (k = { x: f.x + d.x + f.width / 2 + k.x, y: f.y + d.y + { top: 0, middle: 0.5, bottom: 1 }[d.verticalAlign] * f.height }),
            b[g ? 'attr' : 'animate'](k).attr({ align: v }),
            (l = (p + 720) % 360),
            (l = 180 < l && 360 > l),
            'left' === v
              ? (k.y -= l ? n.height : 0)
              ...
              : 'right' === v && ((k.x -= n.width), (k.y -= l ? 0 : n.height)))
          : (b.align(d, null, f), (k = b.alignAttr)),
        y
          ? (a.isLabelJustified = this.justifyDataLabel(b, d, k, n, f, g))
          : t(d.crop, !0) && (u = e.isInsidePlot(k.x, k.y) && e.isInsidePlot(k.x + n.width, k.y + n.height)),
        d.shape && !p)
      )
        b[g ? 'attr' : 'animate']({ anchorX: c ? e.plotWidth - a.plotY : a.plotX, anchorY: c ? e.plotHeight - a.plotX : a.plotY });
    ...
    k.pie &&
              ...
              for (
                b.sortByAngle(c, d - 0.5),
                  0 < b.maxLabelDistance &&
                    ...
                    (f = Math.min(z + p + b.maxLabelDistance, k.plotHeight)),
                    E(c, function (a) {
                      0 < a.labelDistance &&
                        a.dataLabel &&
                        ((a.top = Math.max(0, z - p - a.labelDistance)),
                        (a.bottom = Math.min(z + p + a.labelDistance, k.plotHeight)),
                        (u = a.dataLabel.getBBox().height || 21),
                        (a.positionsIndex = v.push({ target: a.labelPos[1] - a.top + u / 2, size: u, rank: a.y }) - 1));
                    }),
                    a.distribute(v, f + u - e)),
                  R = 0;
                R < n;
                R++
              )
                (g = c[R]),
                  ...
                  (I._attr = { visibility: Q, align: h[6] }),
                  (I._pos = { x: H + l.x + ({ left: m, right: -m }[h[6]] || 0), y: O + l.y - 10 }),
                  (h.x = H),
                  (h.y = O),
                  t(l.crop, !0) &&
                    ((L = I.getBBox().width),
                    (e = null),
                    H - L < m
                      ? ((e = Math.round(L - H + m)), (x[3] = Math.max(e, x[3])))
                      : H + L > r - m && ((e = Math.round(H + L - r + m)), (x[1] = Math.max(e, x[1]))),
                    0 > O - w / 2
                      ? (x[0] = Math.max(Math.round(-O + w / 2), x[0]))
                      : O + w / 2 > q && (x[2] = Math.max(Math.round(O + w / 2 - q), x[2])),
                    (I.sideOverflow = e));
          }),
              ...
              if ((I = a.dataLabel) && I._pos && a.visible && 0 < a.labelDistance) {
                ...
                if ((e = !u))
                  (a.connector = u =
                    k.renderer
                      .path()
                      .addClass('highcharts-data-label-connector highcharts-color-' + a.colorIndex)
                      .add(b.dataLabelsGroup)),
                    u.attr({ 'stroke-width': c, stroke: l.connectorColor || a.color || '#666666' });
                u[e ? 'attr' : 'animate']({ d: b.connectorPath(a.labelPos) });
                u.attr('visibility', Q);
      ...
      (k.pie.prototype.connectorPath = function (a) {
        ...
        return t(this.options.dataLabels.softConnector, !0)
          ? ['M', b + ('left' === a[6] ? 5 : -5), d, 'C', b, d, 2 * a[2] - a[4], 2 * a[3] - a[5], a[2], a[3], 'L', a[4], a[5]]
            ...
            b &&
              ...
              ((a = b._pos)
                ? (b.sideOverflow &&
                    ...
                    b.css({ width: b._attr.width + 'px', textOverflow: 'ellipsis' }),
                    (b.shortened = !0)),
                  b.attr(b._attr),
      ...
      (k.pie.prototype.alignDataLabel = u),
      (k.pie.prototype.verifyDataLabelOverflow = function (a) {
        ...
        c ||
          (null !== e[0]
            ? (k = Math.max(b[2] - Math.max(a[1], a[3]), f))
            : ((k = Math.max(b[2] - a[1] - a[3], f)), (b[0] += (a[3] - a[1]) / 2)),
          null !== e[1]
            ? (k = Math.max(Math.min(k, b[2] - Math.max(a[0], a[2])), f))
            : ((k = Math.max(Math.min(k, b[2] - a[0] - a[2]), f)), (b[1] += (a[0] - a[2]) / 2)),
          k < b[2]
            ? ((b[2] = k), (b[3] = Math.min(g(d.innerSize || 0, k), k)), this.translate(b), this.drawDataLabels && this.drawDataLabels())
            : (c = !0));
        return c;
      }));
    k.column &&
      (k.column.prototype.alignDataLabel = function (a, b, f, g, k) {
        ...
        l &&
          ...
          (l = g.y + g.height - c.yAxis.len),
          0 < l && (g.height -= l),
          e && (g = { x: c.yAxis.len - g.y - g.height, y: c.xAxis.len - g.x - g.width, width: g.height, height: g.width }),
  ...
  (function (a) {
    ...
    C.prototype.hideOverlappingLabels = function (a) {
      ...
      for (u = 0; u < f; u++)
        if ((m = a[u]))
          (m.oldOpacity = m.opacity), (m.newOpacity = 1), m.width || ((t = m.getBBox()), (m.width = t.width), (m.height = t.height));
      a.sort(function (a, b) {
      ...
      for (u = 0; u < f; u++)
        for (t = a[u], m = u + 1; m < f; ++m)
          if (
            ...
            (t.labelrank < g.labelrank ? t : g).newOpacity = 0;
      A(a, function (a) {
        var b, d;
        a &&
          ((d = a.newOpacity),
  ...
  (function (a) {
    ...
    J = a.TrackerMixin = {
        ...
        a._hasTracking ||
          (l(a.trackerGroups, function (c) {
            if (a[c]) {
              ...
              a.options.cursor && a[c].css(E).css({ cursor: a.options.cursor });
            }
          }),
          (a._hasTracking = !0));
      },
      drawTrackerGraph: function () {
        ...
        if (f && !d)
          for (r = f + 1; r--; )
            'M' === e[r] && e.splice(r + 1, 0, e[r + 1] - n, e[r + 2], 'L'),
    ...
    r(v.prototype, {
      select: function (a, b) {
        ...
        c.firePointEvent(a ? 'select' : 'unselect', { accumulate: b }, function () {
          ...
          c.setState(a && 'select');
          b ||
            l(f.getSelectedPoints(), function (a) {
              a.selected &&
                a !== c &&
                ((a.selected = a.options.selected = !1),
                (d.options.data[g(a, d.data)] = a.options),
                a.setState(''),
        ...
        if (
          ...
          if (this.graphic)
            ...
            if (a && n) {
              ...
              if (t) t[b ? 'animate' : 'attr']({ x: A.x, y: A.y });
              else
                l &&
                  ((g.stateMarkerGraphic = t = v.renderer.symbol(l, A.x, A.y, A.width, A.height).add(g.markerGroup)),
                  (t.currentSymbol = l));
          ...
          (c = k.halo) && c.size
            ? (y || (g.halo = y = v.renderer.path().add((this.graphic || t).parentGroup)),
              y[b ? 'animate' : 'attr']({ d: this.haloPath(c.size) }),
              y.attr({ class: 'highcharts-halo highcharts-color-' + e(this.colorIndex, g.colorIndex) }),
              (y.point = this),
              y.attr(r({ fill: this.color || g.color, 'fill-opacity': c.opacity, zIndex: -1 }, c.attributes)))
            : y && y.point && y.point.haloPath && y.animate({ d: y.point.haloPath(0) });
          this.state = a;
        }
      },
      haloPath: function (a) {
    ...
    r(y.prototype, {
      ...
      setState: function (a) {
        ...
        if (
          b.state !== a &&
          (l([b.group, b.markerGroup, b.dataLabelsGroup], function (c) {
  ...
  (function (a) {
    ...
    C.prototype.setResponsive = function (f) {
      ...
      var d = a.merge.apply(
        ...
        m = m.toString() || void 0;
      m !== (g && g.ruleIds) &&
        (g && this.update(g.undoOptions, f),
        m
          ? ((this.currentResponsive = { ruleIds: m, mergedOptions: d, undoOptions: this.currentOptions(d) }), this.update(d, f))
    ...
    C.prototype.matchResponsiveRule = function (a, l) {
      ...
      (
        ...
        function () {
          return (
            this.chartWidth <= f(m.maxWidth, Number.MAX_VALUE) &&
            this.chartHeight <= f(m.maxHeight, Number.MAX_VALUE) &&
            this.chartWidth >= f(m.minWidth, 0) &&
            this.chartHeight >= f(m.minHeight, 0)
          );
        }
