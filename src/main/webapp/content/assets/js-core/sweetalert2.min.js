  ...
  var e = {
    ...
    k = function (e) {
      ...
      var n = t.concat(
        Array.prototype.slice.call(
          c().querySelectorAll('button, input:not([type=hidden]), textarea, select, a, *[tabindex]:not([tabindex="-1"])')
        )
      );
      return i(n);
    },
    ...
    Z = function () {
      null === a.previousBodyPadding &&
        ...
        ((a.previousBodyPadding = document.body.style.paddingRight), (document.body.style.paddingRight = N() + 'px'));
    },
    Q = function () {
    ...
    $ = function e() {
        ...
        case 'object':
          I(l, o[0]),
            ...
            'url' === l.input &&
              ...
              (l.inputValidator = function (e) {
                return new Promise(function (t, n) {
                  /^https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_+.~#?&//=]*)$/.test(e)
                    ? t()
                    : n('Invalid URL');
                });
              });
      ...
      return new Promise(function (t, o) {
            ...
            L = function (n) {
              ...
              switch (i.type) {
                ...
                case 'mouseup':
                  l.buttonsStyling &&
                    (c
                      ? (s.style.backgroundColor = r(l.confirmButtonColor, -0.1))
                      : d && (u.style.backgroundColor = r(l.cancelButtonColor, -0.1)));
                  break;
                case 'mouseout':
                  l.buttonsStyling &&
                    (c ? (s.style.backgroundColor = l.confirmButtonColor) : d && (u.style.backgroundColor = l.cancelButtonColor));
                  break;
                case 'mousedown':
                  l.buttonsStyling &&
                    (c
                      ? (s.style.backgroundColor = r(l.confirmButtonColor, -0.2))
                      : d && (u.style.backgroundColor = r(l.cancelButtonColor, -0.2)));
                  break;
                case 'click':
                  if (c && e.isVisible())
                    ...
                    d &&
                      e.isVisible() &&
                      (e.disableButtons(), e.closeModal(l.onClose), l.useRejections ? o('cancel') : t({ dismiss: 'cancel' }));
              }
            },
        ...
        (window.onkeydown && window.onkeydown.toString() === D.toString()) ||
          ((a.previousWindowKeyDown = window.onkeydown), (window.onkeydown = D)),
        ...
        ('select' !== l.input && 'radio' !== l.input) ||
          (l.inputOptions instanceof Promise
            ...
            ? G(l.inputOptions)
            : console.error('SweetAlert2: Unexpected type of inputOptions! Expected object or Promise, got ' + R(l.inputOptions))),
          z(l.animation, l.onOpen),
          l.allowEnterKey ? K(-1, 1) : document.activeElement && document.activeElement.blur(),
          (u().scrollTop = 0),
          'undefined' == typeof MutationObserver ||
            W ||
            (W = new MutationObserver(e.recalculateHeight)).observe(d, { childList: !0, characterData: !0, subtree: !0 });
      });
    };
  return (
    ($.isVisible = function () {
    ...
    ($.setDefaults = function (t) {
      ...
      for (var n in t)
        e.hasOwnProperty(n) || 'extraParams' === n || (console.warn('SweetAlert2: Unknown parameter "' + n + '"'), delete t[n]);
      I(K, t);
    }),
