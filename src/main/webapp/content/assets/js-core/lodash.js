...
(function () {
  ...
  function runInContext(context) {
    ...
    function baseHas(object, key) {
      ...
      return (
        object != null &&
        (hasOwnProperty.call(object, key) || (typeof object == 'object' && key in object && getPrototype(object) === null))
      );
    }
    ...
    function template(string, options, guard) {
      ...
      var sourceURL =
        '//# sourceURL=' + ('sourceURL' in options ? options.sourceURL : 'lodash.templateSources[' + ++templateCounter + ']') + '\n';
