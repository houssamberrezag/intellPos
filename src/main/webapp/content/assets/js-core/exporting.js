...
(function (k) {
  ...
  (function (f) {
    ...
    f.post = function (a, b, e) {
      var c = r('form', n({ method: 'post', action: a, enctype: 'multipart/form-data' }, e), { display: 'none' }, p.body);
      G(b, function (a, b) {
    ...
    t(B.prototype, {
      ...
      getSVG: function (a) {
        ...
        h(this.series, function (a) {
          w = n(a.userOptions, { animation: !1, enableMouseTracking: !1, showCheckbox: !1, visible: a.visible });
      ...
      contextMenu: function (a, b, e, c, w, m, g) {
        var d = this,
          ...
          A;
        l ||
          ((d[n] = l = r('div', { className: a }, { position: 'absolute', zIndex: 1e3, padding: y + 'px' }, d.container)),
          (z = r('div', { className: 'highcharts-menu' }, null, l)),
          v(z, t({ MozBoxShadow: '3px 3px 10px #888', WebkitBoxShadow: '3px 3px 10px #888', boxShadow: '3px 3px 10px #888' }, u.menuStyle)),
          (A = function () {
            v(l, { display: 'none' });
            g && g.setState(0);
            d.openMenu = !1;
      ...
      addButton: function (a) {
        ...
        if (!1 !== c.enabled) {
          ...
          c.text && c.symbol ? (h.paddingLeft = D(h.paddingLeft, 25)) : c.text || t(h, { width: c.width, height: c.height, padding: 0 });
          d = e
            .button(c.text, 0, 0, l, h, p, q)
            .addClass(a.className)
            .attr({ 'stroke-linecap': 'round', title: b.options.lang[c._titleKey], zIndex: 3 });
          ...
          d.add().align(t(c, { width: d.width, x: D(c.x, b.buttonOffset) }), !0, 'spacingBox');
