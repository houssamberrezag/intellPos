...
class PaymentResourceIT {
    ...
    void createPayment() throws Exception {
        ...
        assertThat(testPayment.getReferenceNo()).isEqualTo(DEFAULT_REFERENCE_NO);
        ...
        assertThat(testPayment.getDeletedAt()).isEqualTo(DEFAULT_DELETED_AT);
    }
    ...
    void putNewPayment() throws Exception {
        ...
        assertThat(testPayment.getReferenceNo()).isEqualTo(UPDATED_REFERENCE_NO);
        ...
        assertThat(testPayment.getDeletedAt()).isEqualTo(UPDATED_DELETED_AT);
    }
    ...
    void partialUpdatePaymentWithPatch() throws Exception {
        ...
        partialUpdatedPayment.method(UPDATED_METHOD).note(UPDATED_NOTE).createdAt(UPDATED_CREATED_AT);
