...
class PersonResourceIT {
    ...
    private static final PersonTypes DEFAULT_PERSON_TYPE = PersonTypes.CLIENT;
    private static final PersonTypes UPDATED_PERSON_TYPE = PersonTypes.FOURNISSEUR;

    private static final Double DEFAULT_PROVIOUS_DUE = 1D;
    private static final Double UPDATED_PROVIOUS_DUE = 2D;
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person()
            ...
            .proviousDue(DEFAULT_PROVIOUS_DUE)
    ...
    public static Person createUpdatedEntity(EntityManager em) {
        Person person = new Person()
            ...
            .proviousDue(UPDATED_PROVIOUS_DUE)
    ...
    void createPerson() throws Exception {
        ...
        assertThat(testPerson.getCompanyName()).isEqualTo(DEFAULT_COMPANY_NAME);
        ...
        assertThat(testPerson.getProviousDue()).isEqualTo(DEFAULT_PROVIOUS_DUE);
        assertThat(testPerson.getAccountNo()).isEqualTo(DEFAULT_ACCOUNT_NO);
        ...
        assertThat(testPerson.getDeletedAt()).isEqualTo(DEFAULT_DELETED_AT);
    }
    ...
    void getAllPeople() throws Exception {
        ...
        restPersonMockMvc
            ...
            .andExpect(jsonPath("$.[*].proviousDue").value(hasItem(DEFAULT_PROVIOUS_DUE.doubleValue())))
    ...
    void getPerson() throws Exception {
        ...
        restPersonMockMvc
            ...
            .andExpect(jsonPath("$.proviousDue").value(DEFAULT_PROVIOUS_DUE.doubleValue()))
    ...
    void putNewPerson() throws Exception {
        ...
        assertThat(testPerson.getCompanyName()).isEqualTo(UPDATED_COMPANY_NAME);
        ...
        assertThat(testPerson.getProviousDue()).isEqualTo(UPDATED_PROVIOUS_DUE);
        assertThat(testPerson.getAccountNo()).isEqualTo(UPDATED_ACCOUNT_NO);
        ...
        assertThat(testPerson.getDeletedAt()).isEqualTo(UPDATED_DELETED_AT);
    }
